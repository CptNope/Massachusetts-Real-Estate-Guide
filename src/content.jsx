      ...
      <>
        ...
        <div className="contract-type-box">
          ...
          <div className="warning-box">
            <p><strong>âš ï¸ Massachusetts Statute of Frauds:</strong> Many contracts MUST be in writing to be enforceable (see Section 35.5)</p>
          </div>
        </div>
        ...
        <div className="contract-type-box">
          ...
          <div className="info-box">
            <p><strong>ðŸ’¡ Note:</strong> While implied contracts exist, always get it in writing! Written contracts prevent disputes and are required for many real estate transactions.</p>
          </div>
        </div>
        ...
        <div className="contract-type-box">
          ...
          <h5>Structure: Promise â†” Promise</h5>
          <ul>
        ...
        <div className="contract-type-box">
          ...
          <h5>Structure: Promise â†’ Performance (if chosen)</h5>
          <ul>
          ...
          <ul>
            <li><strong>Closed Real Estate Sale:</strong>
              <ul>
                ...
                <li>Both obligations fulfilled â†’ Executed contract</li>
              </ul>
            </li>
            <li><strong>Completed Lease Term:</strong>
              <ul>
                ...
                <li>Lease expired â†’ Executed contract</li>
              </ul>
            </li>
        ...
        <div className="statute-of-frauds-box">
          ...
          <div className="must-be-written">
            <ul>
              <li>âœï¸ Listing agreements</li>
              <li>âœï¸ Purchase and Sale agreements</li>
              <li>âœï¸ Offers to purchase</li>
              <li>âœï¸ Leases longer than 1 year</li>
              <li>âœï¸ Options to buy</li>
              <li>âœï¸ Rights of first refusal</li>
              <li>âœï¸ Easements</li>
              <li>âœï¸ Mortgages and deeds of trust</li>
              <li>âœï¸ Deeds</li>
              <li>âœï¸ Any contract for sale of land or interest in land</li>
            </ul>
          </div>

          <h4>Consequences of Oral Agreement:</h4>
          <div className="danger-box">
            <p><strong>âŒ UNENFORCEABLE:</strong> If required to be in writing but only oral, contract CANNOT be enforced in court.</p>
            <ul>
          ...
          <div className="exam-tip">
            <p><strong>ðŸŽ¯ EXAM TIP:</strong> If exam asks "Can an oral listing agreement be enforced?" â†’ Answer: <strong>NO</strong>. Statute of Frauds requires it in writing.</p>
          </div>
        </div>
        ...
        <div className="elements-grid">
          <div className="element-card">
            ...
            <ul>
              <li>âŒ Minors (under 18) - voidable by minor</li>
              <li>âŒ Mentally incompetent persons - void</li>
              <li>âŒ Intoxicated persons (if so impaired they don't understand) - voidable</li>
              <li>âŒ Persons under guardianship - void unless guardian signs</li>
            </ul>

            <div className="practical-tip">
              <p><strong>ðŸ’¡ Practical Tip:</strong> "Have client sign contract BEFORE buying them a beer. If not, contract is Voidable."</p>
          ...
          <div className="element-card">
            ...
            <ul>
              <li>âŒ <strong>Misrepresentation:</strong> False statement of material fact</li>
              <li>âŒ <strong>Fraud:</strong> Intentional deception to induce agreement</li>
              <li>âŒ <strong>Mistake:</strong> Material error about subject matter or terms</li>
              <li>âŒ <strong>Duress:</strong> Threat or force used to obtain agreement</li>
              <li>âŒ <strong>Undue Influence:</strong> Taking advantage of position of trust</li>
            </ul>
          ...
          <div className="element-card">
            ...
            <ul>
              <li>âœ… Buying/selling property for residence</li>
              <li>âœ… Buying/selling property for investment</li>
              <li>âœ… Leasing property for business</li>
              <li>âœ… Hiring broker to sell property</li>
            </ul>

            <h5>Illegal Purposes (Contract VOID):</h5>
            <ul>
              <li>âŒ Purchase property to operate illegal drug business</li>
              <li>âŒ Lease property for prostitution</li>
              <li>âŒ Contract to violate fair housing laws</li>
              <li>âŒ Agreement to commit fraud</li>
              <li>âŒ Contract that violates zoning laws knowingly</li>
            </ul>

            <div className="warning-box">
              <p><strong>âš ï¸ Important:</strong> If contract has illegal purpose, it is VOID from the beginning. Courts will not enforce it, and parties cannot sue for breach.</p>
            </div>
          </div>
          ...
          <div className="element-card">
            ...
            <ul>
              <li>âœï¸ All contracts for sale of land</li>
              <li>âœï¸ All listing agreements</li>
              <li>âœï¸ Leases over 1 year</li>
              <li>âœï¸ Mortgages and deeds</li>
            </ul>
          ...
          <div className="element-card">
            ...
            <ul>
              <li>âœ… Uniquely identify the property</li>
              <li>âœ… Be clear and unambiguous</li>
              <li>âœ… Allow property to be located</li>
              <li>âŒ Cannot be vague ("my house" insufficient)</li>
            </ul>
          </div>
          ...
          <div className="element-card">
            ...
            <div className="critical-box">
              <p><strong>ðŸš¨ CRITICAL CLAUSE:</strong> When "Time is of the Essence" is in contract, deadlines are STRICT. Missing deadline = breach.</p>
            </div>

            <h5>With "Time is of Essence" Clause:</h5>
            <ul>
              <li>â° Deadlines are MANDATORY, not suggestions</li>
              <li>â° Missing closing date by 1 day = breach</li>
              <li>â° Other party can cancel contract</li>
              <li>â° Breaching party may forfeit deposit</li>
              <li>â° Can sue for specific performance or damages</li>
            </ul>
          ...
          <div className="element-card">
            ...
            <ul>
              <li>âœ… Handwritten signature (most common)</li>
              <li>âœ… Electronic signature (DocuSign, etc.)</li>
              <li>âœ… Digital signature with encryption</li>
              <li>âœ… Mark or "X" (if witnessed and party unable to write)</li>
            </ul>
        ...
        <div className="checklist-box">
          ...
          <ol>
            <li>â˜‘ï¸ <strong>Competent Parties</strong> - Legal capacity (18+, sober, sound mind)</li>
            <li>â˜‘ï¸ <strong>Mutual Assent</strong> - Offer + acceptance, no fraud/mistake</li>
            <li>â˜‘ï¸ <strong>Consideration</strong> - Something of value exchanged</li>
            <li>â˜‘ï¸ <strong>Legality of Object</strong> - Legal purpose</li>
            <li>â˜‘ï¸ <strong>Legal Form</strong> - In writing (Statute of Frauds)</li>
            <li>â˜‘ï¸ <strong>Description of Property</strong> - Accurate identification</li>
            <li>â˜‘ï¸ <strong>Date for Performance</strong> - When obligations due</li>
            <li>â˜‘ï¸ <strong>Time is of Essence</strong> - (If applicable) Strict deadlines</li>
            <li>â˜‘ï¸ <strong>Signatures</strong> - All parties sign</li>
          </ol>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <div className="warning-box">
          <p><strong>âš ï¸ CRITICAL CHANGE:</strong> This is a MAJOR shift in how buyer representation works. You can NO LONGER show 
        ...
        <h4>Applies To:</h4>
        <ul>
          <li>âœ… In-person home tours of MLS-listed properties</li>
          <li>âœ… Virtual home tours of MLS-listed properties</li>
          <li>âœ… Any property tour arranged through MLS</li>
          <li>âœ… Both exclusive and non-exclusive buyer agreements</li>
        </ul>

        <h4>Does NOT Apply To:</h4>
        <ul>
          <li>âŒ Open houses (general public, no prior agreement needed)</li>
          <li>âŒ Simply speaking to potential buyer about services</li>
          <li>âŒ Explaining your services at initial meeting</li>
          <li>âŒ Non-MLS properties (for sale by owner, etc.)</li>
          <li>âŒ Agents who are not Realtors (not MLS members)</li>
        </ul>

        <h3>34.3 When Agreement is Required</h3>

        <div className="timing-requirements">
          <h4>âœ… Written Agreement REQUIRED Before:</h4>
          <ul>
          ...
          <h4>âŒ Written Agreement NOT Required For:</h4>
          <ul>
        ...
        <ul>
          <li>âœ… Buyers can attend open houses without agreement</li>
          <li>âœ… Agent can explain services at open house</li>
          <li>âœ… Agent can provide business card and follow up later</li>
          <li>âŒ But to schedule private tour afterward, agreement needed</li>
        </ul>

        <h4>Initial Consultations - No Agreement Needed:</h4>
        <ul>
          <li>âœ… Can meet with buyer to discuss services</li>
          <li>âœ… Can explain homebuying process</li>
          <li>âœ… Can provide market information</li>
          <li>âœ… Can discuss neighborhoods and price ranges</li>
          <li>âŒ Cannot tour MLS property until agreement signed</li>
        </ul>
        ...
        <ul>
          <li>âš ï¸ NAR ethics violation</li>
          <li>âš ï¸ Potential fines from local Realtor association</li>
          <li>âš ï¸ MLS access restrictions or suspension</li>
          <li>âš ï¸ Professional reputation damage</li>
          <li>âš ï¸ Could affect E&O insurance</li>
        </ul>

        <h4>Best Practice for Compliance:</h4>
        <ul>
          <li>âœ… Never tour MLS property without signed agreement</li>
          <li>âœ… Keep copies of all signed agreements in file</li>
          <li>âœ… Use standard form agreements approved by broker</li>
          <li>âœ… Explain rule to buyers so they understand</li>
          <li>âœ… Date agreements to prove they were signed before tour</li>
        </ul>
        ...
        <h4>For Buyers:</h4>
        <ul>
          <li>âœ… Clear understanding of services before committing</li>
          <li>âœ… Know how much agent costs upfront</li>
          <li>âœ… Can negotiate terms that work for them</li>
          <li>âœ… Protected by written contract</li>
          <li>âœ… Prevents surprise fees or confusion</li>
        </ul>

        <h4>For Agents:</h4>
        <ul>
          <li>âœ… Protected compensation for time/effort</li>
          <li>âœ… Clear expectations from start</li>
          <li>âœ… Reduced risk of unpaid work</li>
          <li>âœ… Professional relationship documented</li>
          <li>âœ… Compliance with new industry standards</li>
        </ul>

        <h4>For Industry:</h4>
        <ul>
          <li>âœ… Increased transparency</li>
          <li>âœ… Higher professionalism</li>
          <li>âœ… Better consumer protection</li>
          <li>âœ… Clearer agency relationships</li>
          <li>âœ… Reduced antitrust concerns</li>
        </ul>
    ...
    body: (
      <>
        ...
        <div className="attorney-involvement">
          ...
          <ul>
            <li>âœ… <strong>Draft P&S Agreement</strong> - Create comprehensive legal contract</li>
            <li>âœ… <strong>Review Offer to Purchase</strong> - Ensure terms are clear and protect client</li>
            <li>âœ… <strong>Negotiate Terms</strong> - Work with other party's attorney on modifications</li>
            <li>âœ… <strong>Title Search</strong> - Research property ownership history and liens</li>
            <li>âœ… <strong>Resolve Title Issues</strong> - Clear clouds on title, liens, encumbrances</li>
            <li>âœ… <strong>Review All Documents</strong> - Closing disclosure, deed, settlement statement</li>
            <li>âœ… <strong>Explain Legal Implications</strong> - Clarify what terms mean legally</li>
            <li>âœ… <strong>Conduct Closing</strong> - Handle settlement, signing, recording</li>
            <li>âœ… <strong>Prepare Deed</strong> - Draft legal document transferring ownership</li>
            <li>âœ… <strong>Record Documents</strong> - File with Registry of Deeds</li>
            <li>âœ… <strong>Disburse Funds</strong> - Manage escrow and closing funds</li>
          </ul>
        ...
        <div className="proper-language">
          ...
          <h4>âŒ DO NOT SAY:</h4>
          <ul>
            <li>âŒ "You don't need an attorney." (Unauthorized practice of law)</li>
            <li>âŒ "This means you have to..." (Interpreting legal consequences)</li>
            <li>âŒ "The law requires..." (Giving legal advice)</li>
            <li>âŒ "I'll just cross that out." (Modifying legal documents)</li>
            <li>âŒ "Let me explain what this clause means legally..." (Legal interpretation)</li>
            <li>âŒ "You should do..." (Legal advice)</li>
            <li>âŒ "Attorneys just slow things down." (Discouraging attorney use)</li>
            <li>âŒ "Attorneys are too expensive - I can handle it." (Misrepresentation)</li>
          </ul>
        </div>
        ...
        <div className="unauthorized-practice">
          ...
          <ul>
            <li>âŒ Draft contracts (only use approved standard forms)</li>
            <li>âŒ Interpret legal documents or consequences</li>
            <li>âŒ Give legal advice</li>
            <li>âŒ Advise whether attorney is needed</li>
            <li>âŒ Modify legal language in contracts</li>
            <li>âŒ Explain what "the law requires"</li>
            <li>âŒ Practice law in any form</li>
          </ul>

          <h4>What Agents CAN Do:</h4>
          <ul>
            <li>âœ… Explain terms in standard real estate forms</li>
            <li>âœ… Recommend clients consult with an attorney</li>
            <li>âœ… Provide names of attorneys (2-3 recommendations)</li>
            <li>âœ… Facilitate the transaction process</li>
            <li>âœ… Coordinate between parties and attorneys</li>
            <li>âœ… Explain customary practices in MA</li>
          </ul>

          <p className="warning">
            <strong>âš ï¸ Consequences of Unauthorized Practice of Law:</strong> License suspension or revocation, 
    ...
    body: (
      <>
        ...
        <div className="sequence-flow">
          <ol>
            <li>âœ… <strong>Offer</strong> â†’ Accepted</li>
            <li>âœ… <strong>P&S</strong> â†’ Within 10 days</li>
            <li>âœ… <strong>Inspection</strong> â†’ Within 10 days</li>
            <li>âœ… <strong>Financing Starts</strong> â†’ Couple days after P&S</li>
            <li>âœ… <strong>Appraisal & Title Ordered</strong> â†’ Immediately</li>
            <li>âœ… <strong>Commitment Letter</strong> â†’ 30-45 days from P&S</li>
            <li>âœ… <strong>Clear Conditions</strong> â†’ Before closing</li>
            <li>âœ… <strong>Clear to Close</strong> â†’ Days before closing</li>
            <li>âœ… <strong>Closing</strong> â†’ Per contract terms</li>
          </ol>
        </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>âœ… Clear expectations and responsibilities</li>
          <li>âœ… Documented compensation agreements</li>
          <li>âœ… Legal enforceability</li>
          <li>âœ… Proper disclosure to all parties</li>
          <li>âœ… Protection from misunderstandings</li>
        </ul>
        ...
        <div className="listing-types">
          <div className="listing-type">
            ...
            <p className="highlight">
              <strong>âœ… MOST COMMONLY USED IN TODAY'S MARKET</strong>
            </p>
            <p>
          ...
          <div className="listing-type">
            ...
            <p className="warning">
              <strong>âš ï¸ RARELY USED</strong>
            </p>
            <p>
          ...
          <div className="listing-type">
            ...
            <p className="warning">
              <strong>âŒ NEVER USED IN PROFESSIONAL PRACTICE</strong>
            </p>
            <p>
          ...
          <div className="listing-type">
            <h5>4. Net Listing</h5>
            <p className="danger">
              <strong>ðŸš« ILLEGAL IN MASSACHUSETTS (over $300,000)</strong>
            </p>
            <p>
            ...
            <div className="danger-box">
              <p><strong>âš ï¸ LICENSE VIOLATION:</strong> Using net listings over $300,000 can result in license suspension 
        ...
        <h4>ðŸ“‹ Important Disclosure Requirement</h4>
        <div className="warning-box">
          <p className="highlight">
            <strong>âš ï¸ CRITICAL:</strong> If you don't give the seller a copy of the signed listing agreement, 
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>âŒ No (commission still owed)</td>
                <td>âœ… Yes</td>
                <td>âœ… Most common</td>
              </tr>
              <tr>
                <td><strong>Exclusive Agency</strong></td>
                <td>Listing broker if they sell</td>
                <td>âœ… Yes (no commission)</td>
                <td>âŒ No</td>
                <td>âš ï¸ Rarely used</td>
              </tr>
              <tr>
                <td><strong>Open Listing</strong></td>
                <td>Broker who procures buyer</td>
                <td>âœ… Yes (no commission)</td>
                <td>âš ï¸ Yes (competing)</td>
                <td>âŒ Never used</td>
              </tr>
              <tr className="danger-row">
                ...
                <td>N/A</td>
                <td>N/A</td>
                <td>ðŸš« ILLEGAL (over $300k)</td>
              </tr>
              <tr>
                <td><strong>Entry Only</strong></td>
                <td>Flat fee to broker</td>
                <td>âœ… Yes (seller manages)</td>
                <td>âœ… Buyer agents welcome</td>
                <td>âš ï¸ Limited use</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="warning-box">
          <p><strong>âš ï¸ DANGER ZONE:</strong> This is how agents accidentally create agency relationships without intending to!</p>
        ...
        <ul>
          <li>âŒ Undisclosed dual agency violations</li>
          <li>âŒ Fiduciary duty breaches</li>
          <li>âŒ Liability for misrepresentation</li>
          <li>âŒ License disciplinary action</li>
          <li>âŒ Lawsuits from confused parties</li>
          <li>âŒ Commission disputes</li>
        </ul>

        <h4>How to Avoid Implied Agency:</h4>
        <ul>
          <li>âœ… Provide Agency Disclosure Form at first personal meeting (REQUIRED in MA)</li>
          <li>âœ… Get written buyer-broker agreement BEFORE showing properties</li>
          <li>âœ… Clarify your role explicitly: "I represent the seller" or "I represent you as the buyer"</li>
          <li>âœ… Don't provide advice or advocacy to unrepresented parties</li>
          <li>âœ… Document all agency relationships in writing</li>
          <li>âœ… Be clear about who you work for</li>
        </ul>
        ...
        <ul>
          <li>âœ… Material property defects known to agent</li>
          <li>âœ… "I represent the seller in this transaction"</li>
          <li>âœ… Any conflicts of interest</li>
          <li>âœ… That buyer should consider own representation</li>
        </ul>

        <h4>What Seller's Agent CANNOT Disclose to Buyer:</h4>
        <ul>
          <li>âŒ Seller will accept less than asking price</li>
          <li>âŒ Seller is motivated/desperate to sell</li>
          <li>âŒ Seller facing foreclosure/divorce/job transfer</li>
          <li>âŒ Other offers on the table (unless instructed to disclose)</li>
          <li>âŒ Any seller confidential information</li>
        </ul>
        ...
        <ul>
          <li>âœ… "I represent the buyer in this transaction"</li>
          <li>âœ… Material facts about buyer's ability to perform (if relevant)</li>
          <li>âœ… Any conflicts of interest</li>
        </ul>

        <h4>What Buyer's Agent CANNOT Disclose to Seller:</h4>
        <ul>
          <li>âŒ Buyer will pay more than offered</li>
          <li>âŒ Buyer is desperate/motivated to buy quickly</li>
          <li>âŒ Buyer facing time pressure (job transfer, baby coming, etc.)</li>
          <li>âŒ Buyer's maximum qualifying amount</li>
          <li>âŒ Any buyer confidential information</li>
        </ul>
        ...
        <ul>
          <li>âŒ Fiduciary duties (no OLD CAR)</li>
          <li>âŒ Advocacy or advice</li>
          <li>âŒ Confidentiality of their information</li>
          <li>âŒ Agent's loyalty</li>
          <li>âŒ Negotiation on their behalf</li>
        </ul>
        ...
        <ul>
          <li>âœ… Prepare contracts (fill in blanks with provided information)</li>
          <li>âœ… Coordinate inspections and appraisals</li>
          <li>âœ… Track contingency deadlines</li>
          <li>âœ… Communicate between parties</li>
          <li>âœ… Present offers and counteroffers</li>
        </ul>

        <h4>What Facilitator CANNOT Do:</h4>
        <ul>
          <li>âŒ Give advice to either party</li>
          <li>âŒ Advocate for either party</li>
          <li>âŒ Negotiate on behalf of either party</li>
          <li>âŒ Provide opinions on value, terms, or strategy</li>
          <li>âŒ Recommend one course of action over another</li>
        </ul>
        ...
        <div className="limitations">
          ...
          <ul>
            <li>âŒ <strong>Obedience:</strong> Cannot obey conflicting instructions from both parties</li>
            <li>âŒ <strong>Loyalty:</strong> Cannot be fully loyal to both - inherent conflict</li>
            <li>âœ… <strong>Disclosure:</strong> Must disclose material facts to BOTH</li>
            <li>âœ… <strong>Confidentiality:</strong> MUST maintain confidentiality for BOTH parties</li>
            <li>âœ… <strong>Accountability:</strong> Still accountable to both</li>
            <li>âœ… <strong>Reasonable Care:</strong> Still owe reasonable care to both</li>
          </ul>
        </div>
        ...
        <ul>
          <li>âœ… <strong>Written Disclosure:</strong> Explain dual agency to both parties in writing</li>
          <li>âœ… <strong>Informed Consent:</strong> Both buyer AND seller must consent in writing</li>
          <li>âœ… <strong>Before Proceeding:</strong> Get consent BEFORE continuing with transaction</li>
          <li>âœ… <strong>Explain Limitations:</strong> Make clear they won't get full representation</li>
          <li>âœ… <strong>Right to Refuse:</strong> Either party can refuse and agent must withdraw from one side</li>
          <li>âœ… <strong>Document Everything:</strong> Keep signed disclosure and consent forms</li>
        </ul>

        <h4>Disclosed Dual Agency is LEGAL if:</h4>
        <ul>
          <li>âœ… Properly disclosed in writing to both parties</li>
          <li>âœ… Both parties provide informed written consent</li>
          <li>âœ… Agent maintains confidentiality for both parties</li>
          <li>âœ… Agent stays neutral and doesn't favor either side</li>
          <li>âœ… All material facts disclosed to both parties</li>
        </ul>
        ...
        <div className="critical-warning">
          <h4>âš ï¸ CRITICAL VIOLATION - ALWAYS ILLEGAL</h4>
        ...
        <div className="severe-penalties">
          <ul>
            <li>ðŸš¨ <strong>License Suspension or Revocation</strong></li>
            <li>ðŸš¨ <strong>Lawsuit from Both Parties:</strong> Fraud, breach of fiduciary duty</li>
            <li>ðŸš¨ <strong>Lose Entire Commission:</strong> Courts may order return of all commission</li>
            <li>ðŸš¨ <strong>Damages:</strong> Pay damages to harmed parties</li>
            <li>ðŸš¨ <strong>Criminal Charges:</strong> Fraud charges possible in serious cases</li>
            <li>ðŸš¨ <strong>E&O Won't Cover:</strong> Insurance excludes intentional acts/fraud</li>
            <li>ðŸš¨ <strong>Reputation Destroyed:</strong> Career-ending violation</li>
          </ul>
        </div>

        <h4>Prevention:</h4>
        <ul>
          <li>âœ… Provide Agency Disclosure Form at FIRST meeting (MA law)</li>
          <li>âœ… Recognize in-house transactions immediately</li>
          <li>âœ… Get written dual agency consent BEFORE proceeding</li>
          <li>âœ… Document everything in writing</li>
          <li>âœ… When in doubt, DISCLOSE</li>
          <li>âœ… Consider referring out one side if uncomfortable</li>
        </ul>
        ...
        <ul>
          <li>âŒ Confusing to consumers (buyer thought agent represented them)</li>
          <li>âŒ Buyer had no representation</li>
          <li>âŒ Both agents competed to please seller (not fair to buyer)</li>
          <li>âŒ Liability issues when subagent made mistakes</li>
          <li>âœ… Buyer agency provides better protection and clarity</li>
        </ul>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>Seller only</td>
                <td>âœ… Yes (to seller)</td>
                <td>âœ… Listing agreement</td>
              </tr>
              <tr>
                <td><strong>Buyer's Agent</strong></td>
                <td>Buyer only</td>
                <td>âœ… Yes (to buyer)</td>
                <td>âœ… Buyer agreement</td>
              </tr>
              <tr>
                <td><strong>Dual Agent</strong></td>
                <td>Both buyer & seller</td>
                <td>âš ï¸ Limited to both</td>
                <td>âœ… Required + consent</td>
              </tr>
              <tr>
                <td><strong>Designated Agent</strong></td>
                <td>One party only</td>
                <td>âœ… Yes (to their client)</td>
                <td>âœ… Designation letter</td>
              </tr>
              <tr>
                <td><strong>Facilitator</strong></td>
                <td>Neither party</td>
                <td>âŒ No</td>
                <td>âœ… Disclosure required</td>
              </tr>
              <tr>
                <td><strong>Customer</strong></td>
                <td>Not represented</td>
                <td>âŒ No</td>
                <td>âŒ No agreement</td>
              </tr>
              <tr>
                <td><strong>Subagent</strong></td>
                <td>Another agent's client</td>
                <td>âœ… Yes (through main agent)</td>
                <td>âœ… Consent required</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="key-takeaways">
          <ul>
            <li>âœ… <strong>Always use Express Agency:</strong> Get written agreements, don't rely on implied</li>
            <li>âœ… <strong>Disclose at First Meeting:</strong> MA law requires agency disclosure form</li>
            <li>âœ… <strong>Avoid Undisclosed Dual Agency:</strong> Career-ending violation</li>
            <li>âœ… <strong>Get Dual Agency Consent in Writing:</strong> Before proceeding with in-house transaction</li>
            <li>âœ… <strong>Know Your Role:</strong> Seller's agent, buyer's agent, dual agent, or designated agent</li>
            <li>âœ… <strong>Treat Customers Fairly:</strong> Even if not your client, owe honesty</li>
            <li>âœ… <strong>Document Everything:</strong> Written agreements, disclosures, consents</li>
            <li>âœ… <strong>When in Doubt, Disclose:</strong> Over-disclosure is safer than under-disclosure</li>
          </ul>
        </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <div className="warning-box">
          <p><strong>âš ï¸ Undisclosed Dual Agency Risk:</strong> Agents must be VERY careful not to accidentally create undisclosed dual agency</p>
        ...
        <div className="protocols-allowed">
          <h5>âœ… What You CAN Do:</h5>
          <ul>
            <li>âœ… Share information in office meetings about clients</li>
            <li>âœ… Leave files accessible in the office</li>
            <li>âœ… Discuss strategy with colleagues about shared clients</li>
            <li>âœ… Everything is confidentially kept WITHIN the office</li>
            <li>âœ… Collaborate freely since all agents represent all clients</li>
            <li>âœ… Cover for each other on client matters</li>
          </ul>
        </div>
        ...
        <div className="protocols-restricted">
          <h5>âŒ What You CANNOT Do:</h5>
          <ul>
            <li>âŒ <strong>CANNOT share information</strong> between designated agents about their respective clients</li>
            <li>âŒ <strong>CANNOT leave files in the office</strong> where other designated agents can access them</li>
            <li>âŒ <strong>CANNOT discuss client details</strong> in office meetings if other designated agents are present</li>
            <li>âŒ <strong>CANNOT collaborate</strong> on the transaction with the other designated agent</li>
            <li>âŒ <strong>Must maintain strict firewall</strong> between the two designated agents</li>
            <li>âŒ <strong>Separate file systems</strong> required for each designated agent's clients</li>
          </ul>
        </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>âœ… Can share files and info in office</td>
                <td>âŒ Cannot share - strict firewall</td>
              </tr>
              <tr>
                <td><strong>Collaboration</strong></td>
                <td>âœ… Agents can collaborate on shared clients</td>
                <td>âŒ Designated agents cannot collaborate</td>
              </tr>
              <tr>
        ...
        <div className="pros-cons">
          <h5>Advantages:</h5>
          <ul>
            <li>âœ… Simpler office operations - open collaboration</li>
            <li>âœ… Easy coverage when agents are unavailable</li>
            <li>âœ… Team approach to client service</li>
            <li>âœ… Shared knowledge benefits all clients</li>
            <li>âœ… Less complex compliance requirements</li>
          </ul>

          <h5>Disadvantages:</h5>
          <ul>
            <li>âŒ Automatic dual agency in in-house transactions</li>
            <li>âŒ Limited advocacy when dual agency occurs</li>
            <li>âŒ Higher risk of undisclosed dual agency violations</li>
            <li>âŒ Clients may feel less protected</li>
            <li>âŒ "Guilty by association" can be confusing for clients</li>
          </ul>
        </div>
        ...
        <div className="pros-cons">
          <h5>Advantages:</h5>
          <ul>
            <li>âœ… Full advocacy for clients - each agent can fight for their client</li>
            <li>âœ… Designated agents avoid being dual agents</li>
            <li>âœ… Better client protection through information firewall</li>
            <li>âœ… Clearer agency relationships</li>
            <li>âœ… Both buyer and seller get full representation</li>
            <li>âœ… Keeps transaction in-house while maintaining representation quality</li>
          </ul>

          <h5>Disadvantages:</h5>
          <ul>
            <li>âŒ Strict information firewall requirements</li>
            <li>âŒ Cannot share files or collaborate in office</li>
            <li>âŒ More complex compliance and documentation</li>
            <li>âŒ Difficult to cover for designated agents</li>
            <li>âŒ Requires careful office procedures and training</li>
            <li>âŒ Principal Broker bears dual agency burden</li>
          </ul>
        </div>
        ...
        <ul>
          <li>âœ… Immediately recognize in-house transactions as dual agency</li>
          <li>âœ… Disclose dual agency to both parties IN WRITING before proceeding</li>
          <li>âœ… Get informed consent from both buyer and seller</li>
          <li>âœ… Maintain confidentiality for both parties' sensitive information</li>
          <li>âœ… Stay neutral - do not advocate for either side</li>
          <li>âœ… Document everything - disclosure forms, consent forms</li>
          <li>âœ… Consider referring out one side if dual agency feels uncomfortable</li>
        </ul>

        <h4>If Your Firm Uses Designated Agency:</h4>
        <ul>
          <li>âœ… Wait for Principal Broker to make designation</li>
          <li>âœ… Understand who you represent (buyer OR seller, not both)</li>
          <li>âœ… Do NOT share your client's confidential info with other designated agent</li>
          <li>âœ… Keep files secure and separate from other designated agent's access</li>
          <li>âœ… Advocate fully for YOUR designated client</li>
          <li>âœ… Direct all communications through proper channels</li>
          <li>âœ… Respect the information firewall - it protects everyone</li>
        </ul>
        ...
        <div className="common-mistakes">
          ...
          <ul>
            <li>âŒ Failing to recognize in-house transaction as dual agency</li>
            <li>âŒ Not disclosing dual agency in writing</li>
            <li>âŒ Proceeding without both parties' consent</li>
            <li>âŒ Advocating for one party over the other</li>
            <li>âŒ Sharing one party's confidential info with the other</li>
            <li>âŒ Assuming "everyone knows" = proper disclosure (it doesn't!)</li>
          </ul>

          <h4>Designated Agency Mistakes:</h4>
          <ul>
            <li>âŒ Sharing files or client info with other designated agent</li>
            <li>âŒ Discussing your client's strategy in office meetings</li>
            <li>âŒ Leaving confidential documents where others can see them</li>
            <li>âŒ Thinking you can "informally collaborate" with other side</li>
            <li>âŒ Failing to maintain strict information firewall</li>
            <li>âŒ Acting as dual agent when you're only designated to one client</li>
          </ul>
        </div>
        ...
        <div className="checklist">
          <ul>
            <li>â˜ Agency disclosure form signed at first meeting</li>
            <li>â˜ Listing agreement or buyer agreement specifying agency model</li>
            <li>â˜ Dual agency disclosure (if applicable)</li>
            <li>â˜ Dual agency consent from both parties (if applicable)</li>
            <li>â˜ Designated agency appointment letter (if applicable)</li>
            <li>â˜ Information firewall policy acknowledgment (designated agency)</li>
            <li>â˜ All disclosures in client file for Board inspection</li>
          </ul>
        </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>âœ… Buy, sell, or mortgage real estate</li>
          <li>âœ… Access and manage all bank accounts</li>
          <li>âœ… Sign contracts and legal documents</li>
          <li>âœ… Make investment decisions</li>
          <li>âœ… File taxes and manage financial affairs</li>
          <li>âœ… Make healthcare decisions (if specified)</li>
          <li>âœ… Hire and fire employees/agents</li>
          <li>âœ… Essentially anything the principal could do themselves</li>
        </ul>

        <h4>Why Universal Agency is Rare:</h4>
        <div className="warning-box">
          <p><strong>âš ï¸ Extreme Trust Required:</strong></p>
          <ul>
        ...
        <div className="property-manager-example">
          ...
          <ul>
            <li>âœ… Sign lease agreements with tenants</li>
            <li>âœ… Collect rent payments</li>
            <li>âœ… Hire contractors for repairs and maintenance</li>
            <li>âœ… Evict tenants for non-payment or lease violations</li>
            <li>âœ… Advertise vacancies and show units</li>
            <li>âœ… Handle tenant complaints and maintenance requests</li>
            <li>âœ… Enforce lease terms and building rules</li>
            <li>âœ… Purchase supplies and pay vendors</li>
            <li>âœ… Make day-to-day operational decisions</li>
          </ul>

          <h5>What Property Manager CANNOT Do (Outside Scope):</h5>
          <ul>
            <li>âŒ Sell the apartment building (outside their authority)</li>
            <li>âŒ Mortgage the property</li>
            <li>âŒ Make major capital improvements without owner approval</li>
            <li>âŒ Change the fundamental use of the property</li>
            <li>âŒ Act on owner's behalf in unrelated business matters</li>
          </ul>
        </div>
        ...
        <div className="critical-point">
          <p><strong>ðŸ  This is YOU as a Real Estate Agent!</strong></p>
        ...
        <div className="broker-authority">
          ...
          <ul>
            <li>âœ… Market and advertise the property (if listing agent)</li>
            <li>âœ… Show the property to prospective buyers</li>
            <li>âœ… Find suitable properties (if buyer's agent)</li>
            <li>âœ… Present offers and counteroffers between parties</li>
            <li>âœ… Negotiate terms on behalf of client (within parameters)</li>
            <li>âœ… Provide market data and comparative analysis</li>
            <li>âœ… Coordinate inspections, appraisals, and closing</li>
            <li>âœ… Facilitate the transaction to closing</li>
            <li>âœ… Provide professional real estate advice</li>
          </ul>

          <h5>What Real Estate Brokers are NOT Authorized to Do:</h5>
          <ul>
            <li>âŒ <strong>Sign contracts on behalf of client</strong> (client must sign themselves)</li>
            <li>âŒ <strong>Accept or reject offers</strong> (only client can accept/reject)</li>
            <li>âŒ <strong>Change material terms</strong> without client's specific approval</li>
            <li>âŒ <strong>Bind client to any agreement</strong> without client's signature</li>
            <li>âŒ <strong>Access client's bank accounts</strong> or personal funds</li>
            <li>âŒ <strong>Make decisions</strong> on behalf of client (only present options)</li>
            <li>âŒ <strong>Practice law</strong> (review contracts, give legal advice)</li>
            <li>âŒ <strong>Act as attorney-in-fact</strong> or sign legal documents for client</li>
          </ul>
        </div>
        ...
        <div className="common-mistakes">
          <ul>
            <li>âŒ Agent accepts offer on behalf of seller without seller's signature</li>
            <li>âŒ Agent agrees to change material terms without client approval</li>
            <li>âŒ Agent signs documents "on behalf of" client</li>
            <li>âŒ Agent makes binding commitments client didn't authorize</li>
            <li>âŒ Agent tries to act as power of attorney without proper documentation</li>
          </ul>
        </div>
        ...
        <div className="client-language">
          ...
          <p><strong>âŒ Incorrect:</strong></p>
          <ul>
        ...
        <div className="key-takeaways">
          <ul>
            <li>âœ… <strong>Know Your Authority Level:</strong> You are a SPECIAL AGENT with limited authority</li>
            <li>âœ… <strong>Cannot Sign for Clients:</strong> All contracts require client's personal signature</li>
            <li>âœ… <strong>Cannot Accept/Reject:</strong> Only client can accept or reject offers</li>
            <li>âœ… <strong>Facilitate, Don't Decide:</strong> Your role is to facilitate and advise, not make decisions</li>
            <li>âœ… <strong>Get Client Approval:</strong> Material changes require client's specific approval</li>
            <li>âœ… <strong>Document Authority:</strong> Your authority comes from listing/buyer agreement (special agent)</li>
            <li>âœ… <strong>Stay in Your Lane:</strong> Don't try to act as universal or general agent</li>
            <li>âœ… <strong>Respect Limitations:</strong> Your limitations protect both you and your client</li>
          </ul>
        </div>
    ...
    body: (
      <>
        ...
        <div className="agreement-type">
          ...
          <ul>
            <li>âœ… Agent's full commitment and loyalty</li>
            <li>âœ… Exclusive access to agent's time and resources</li>
            <li>âœ… Agent will aggressively represent buyer's interests</li>
            <li>âœ… Clear understanding of agent's duties and compensation</li>
            <li>âœ… Legal protection through written contract</li>
          </ul>

          <h4>Benefits to Agent:</h4>
          <ul>
            <li>âœ… Protected compensation for time and effort</li>
            <li>âœ… Buyer cannot "jump" to another agent</li>
            <li>âœ… Investment in relationship is protected</li>
            <li>âœ… Clear expectations and boundaries</li>
          </ul>
        ...
        <div className="agreement-type">
          ...
          <h4>Commission Structure:</h4>
          <div className="warning-box">
            <p><strong>âš ï¸ CRITICAL:</strong> The agent who <strong>sells Buyer a home</strong> is due a commission. All other 
            agents involved are not due anything.</p>
          </div>

          <h4>Benefits to Buyer:</h4>
          <ul>
            <li>âœ… Flexibility to work with multiple agents</li>
            <li>âœ… Can compare agent services and styles</li>
            <li>âœ… No obligation if not satisfied with one agent</li>
            <li>âœ… Can switch agents without penalty</li>
          </ul>

          <h4>Drawbacks to Buyer:</h4>
          <ul>
            <li>âŒ Agents may not fully commit time/resources</li>
            <li>âŒ Less loyalty from agents</li>
            <li>âŒ Potential for confusion and miscommunication</li>
            <li>âŒ Agents competing against each other, not cooperating</li>
          </ul>

          <h4>Benefits to Agent:</h4>
          <ul>
            <li>âœ… Can sign up buyers without exclusive commitment</li>
            <li>âœ… Easier to get buyers to sign agreement</li>
          </ul>

          <h4>Drawbacks to Agent:</h4>
          <ul>
            <li>âŒ No protected commission - only paid if buyer purchases through you</li>
            <li>âŒ Competing with other agents for same buyer</li>
            <li>âŒ Risk of investing time with no compensation</li>
            <li>âŒ Buyer may use your work to purchase with another agent</li>
          </ul>
        </div>
        ...
        <ul>
          <li>âœ… Clear documentation of terms</li>
          <li>âœ… Legal enforceability</li>
          <li>âœ… Proof of agency relationship</li>
          <li>âœ… Protection for both parties</li>
          <li>âœ… Prevents misunderstandings</li>
          <li>âœ… Required for MLS tours (Aug 2024 rule - see Section 34)</li>
        </ul>

        <h4>Verbal Agreements (Not Recommended):</h4>
        <ul>
          <li>âŒ Hard to prove terms</li>
          <li>âŒ Misunderstandings common</li>
          <li>âŒ Difficult to enforce</li>
          <li>âŒ No clear commission agreement</li>
          <li>âŒ Can't tour MLS properties (new rule)</li>
        </ul>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>âœ… Yes - One agent only</td>
                <td>âŒ No - Multiple agents allowed</td>
              </tr>
              <tr>
                <td><strong>Buyer Commitment</strong></td>
                <td>âœ… Committed to agent</td>
                <td>âŒ Not committed</td>
              </tr>
              <tr>
                <td><strong>Agent Commitment</strong></td>
                <td>âœ… Agent commits full service</td>
                <td>âš ï¸ Less commitment</td>
              </tr>
              <tr>
                <td><strong>Commission Protection</strong></td>
                <td>âœ… Agent paid regardless of who finds property</td>
                <td>âŒ Only if agent procures the sale</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>âŒ No - exclusive agent only</td>
                <td>âŒ No - only procuring agent</td>
              </tr>
              <tr>
                <td><strong>Buyer Flexibility</strong></td>
                <td>âŒ Low - locked in</td>
                <td>âœ… High - can shop around</td>
              </tr>
              <tr>
                <td><strong>Agent Investment</strong></td>
                <td>âœ… High - protected</td>
                <td>âŒ Low - risky</td>
              </tr>
            </tbody>
          </table>
      ...
      <>
        ...
        <div className="termination-method">
          ...
          <div className="success-box">
            <p><strong>âœ… AGENT EARNS COMMISSION:</strong> When agency terminates due to successful completion, agent has earned 
        ...
        <div className="termination-method">
          ...
          <div className="warning-box">
            <p><strong>âš ï¸ CRITICAL:</strong> Principal has the <strong>POWER</strong> to revoke at any time, but may not always 
        ...
        <div className="termination-method">
          ...
          <div className="warning-box">
            <p><strong>âš ï¸ DANGER:</strong> Agent who abandons client without justification may lose commission AND face 
        ...
        <div className="warning-box">
          <p><strong>âš ï¸ CRITICAL:</strong> Agency termination does NOT end ALL obligations. Some duties continue FOREVER.</p>
        </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>âœ… Yes</td>
                <td>âŒ Forfeited if wrongful</td>
                <td>Never abandon client!</td>
              </tr>
              <tr>
                <td><strong>Death</strong></td>
                <td>âŒ No</td>
                <td>âŒ Not earned</td>
    ...
    body: (
      <>
        ...
        <div className="violation-examples">
          <h5>âŒ Refusing to Show/Rent/Sell</h5>
          <ul>
          ...
          <h5>âŒ Different Terms or Conditions</h5>
          <ul>
          ...
          <h5>âŒ Discriminatory Advertising</h5>
          <ul>
          ...
          <h5>âŒ Disability Discrimination</h5>
          <ul>
          ...
          <h5>âŒ Medical Condition Discrimination (CRITICAL!)</h5>
          <div className="medical-discrimination-warning">
            <p className="highlight">
              <strong>ðŸš¨ It's ILLEGAL to discriminate in the sale or rental of housing based on HIV or AIDS status.</strong>
            </p>
            <ul>
            ...
            <p className="liability-warning">
              <strong>âš ï¸ Violations:</strong> HIPAA violations can result in criminal penalties up to $250,000 and 10 years in prison, 
              plus Fair Housing Act violations with fines up to $100,000+.
            </p>
          </div>

          <h5>âŒ Familial Status Discrimination</h5>
          <ul>
        ...
        <div className="advertising-rules">
          ...
          <h4>âš ï¸ USE WITH EXTREME CAUTION:</h4>
          <ul>
          ...
          <h4>âŒ NEVER USE - Prohibited Language:</h4>
          <ul>
        ...
        <div className="disability-rules">
          ...
          <ul>
            <li>âœ… "Can you provide documentation from a healthcare provider that you have a disability?"</li>
            <li>âœ… "Can you explain how the requested accommodation relates to your disability?"</li>
          </ul>

          <h4>What You CANNOT Ask:</h4>
          <ul>
            <li>âŒ "What's wrong with you?"</li>
            <li>âŒ "How severe is your disability?"</li>
            <li>âŒ "Can you show me your medical records?"</li>
            <li>âŒ "Are you taking medication?"</li>
          </ul>
        </div>
        ...
        <div className="penalties">
          ...
          <ul>
            ...
            <li>Expulsion from RealtorÂ® membership</li>
          </ul>
        </div>
        ...
        <div className="best-practices">
          <h4>DO:</h4>
          <ul>
            <li>âœ… Treat everyone equally regardless of protected class</li>
            <li>âœ… Use the same criteria for all applicants</li>
            <li>âœ… Document all decisions with legitimate business reasons</li>
            <li>âœ… Refuse discriminatory requests from clients</li>
            <li>âœ… Provide equal service to all</li>
            <li>âœ… Show all available properties that meet stated criteria</li>
            <li>âœ… Take Fair Housing training regularly</li>
            <li>âœ… Display Equal Housing Opportunity logo</li>
            <li>âœ… Keep records of all applicants and why each was accepted/rejected</li>
          </ul>

          <h4>DON'T:</h4>
          <ul>
            <li>âŒ Steer based on protected class</li>
            <li>âŒ Use discriminatory language in advertising</li>
            <li>âŒ Ask about protected class status</li>
            <li>âŒ Make assumptions about "fit" based on protected class</li>
            <li>âŒ Accommodate client's discriminatory requests</li>
            <li>âŒ Tell different stories to different people</li>
            <li>âŒ Volunteer protected class information about neighborhoods</li>
            <li>âŒ Ignore Fair Housing obligations because client insists</li>
          </ul>
        </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <div className="warning-box">
          <p><strong>âš ï¸ CRITICAL:</strong> This is a LEGAL OBLIGATION, not optional. Failure to disclose known defects can result 
        ...
        <ul>
          <li>âŒ Hire inspectors to find defects</li>
          <li>âŒ Conduct invasive testing</li>
          <li>âŒ Investigate rumors or speculation</li>
          <li>âŒ Disclose defects they genuinely don't know about</li>
        </ul>

        <h4>Seller DOES Have To:</h4>
        <ul>
          <li>âœ… Disclose all defects they personally know about</li>
          <li>âœ… Disclose defects previous owners told them about</li>
          <li>âœ… Disclose defects found in inspection reports they received</li>
          <li>âœ… Disclose violations or notices received from city/town</li>
          <li>âœ… Be truthful if buyer asks direct questions</li>
        </ul>
        ...
        <div className="sample-language">
          ...
          <p><strong>âœ…</strong> "Foundation has minor cracks in northeast corner of basement. Had structural engineer inspect in 2020 
          who said it was not structural. Report available upon request."</p>
          
          <p><strong>âœ…</strong> "Roof is 18 years old. Had leak in 2019 over master bedroom which was repaired. No leaks since repair."</p>
          
          <p><strong>âœ…</strong> "Finished basement was done without permits in 2015. Town was never notified. Used licensed electrician 
          and plumber but didn't pull permits."</p>

          <h4>Bad Disclosure Examples:</h4>
          <p><strong>âŒ</strong> "Roof has some issues" (Too vague - what issues?)</p>
          
          <p><strong>âŒ</strong> "Everything is fine as far as I know" (Not specific enough)</p>
          
          <p><strong>âŒ</strong> Leaving sections blank or marking "Unknown" when seller actually knows</p>
        </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <div className="warning-box">
          <p><strong>âš ï¸ CRITICAL REQUIREMENT:</strong> This brochure must be provided when the FIRST written offer/contract is signed, 
        ...
        <div className="warning-box">
          <p><strong>âŒ PROHIBITED:</strong> Listing Agents and Dual Agents <strong>cannot recommend a specific inspector or 
          inspection company</strong>.</p>
        </div>

        <h5>What Listing/Dual Agents CAN Do:</h5>
        <ul>
          <li>âœ… Provide the state website with list of licensed inspectors</li>
          <li>âœ… Explain the importance of home inspections</li>
          <li>âœ… Encourage buyer to get an inspection</li>
          <li>âœ… Answer general questions about the inspection process</li>
          <li>âœ… Provide the "Facts for Consumers" brochure</li>
        </ul>

        <h5>What Listing/Dual Agents CANNOT Do:</h5>
        <ul>
          <li>âŒ Recommend a specific inspector by name</li>
          <li>âŒ Suggest a particular inspection company</li>
          <li>âŒ Give buyer a list of "preferred" inspectors</li>
          <li>âŒ Steer buyer toward any specific inspector</li>
        </ul>
        ...
        <div className="success-box">
          <p><strong>âœ… PERMITTED:</strong> Buyer Agents <strong>can recommend</strong> specific inspectors IF they meet certain conditions.</p>
        </div>
        ...
        <div className="scenario-box">
          ...
          <p><strong>âŒ Wrong Answer:</strong> "Sure, use ABC Inspections. They're great."</p>
          <p><strong>âœ… Correct Answer:</strong> "As the listing agent, I cannot recommend a specific inspector. However, I can provide 
        ...
        <div className="scenario-box">
          ...
          <p><strong>âœ… Correct Answer:</strong> "Since I'm your buyer's agent, I can provide some recommendations. Here are three 
        ...
        <div className="scenario-box">
          ...
          <p><strong>âŒ Wrong Answer:</strong> "I know a great inspector..."</p>
          <p><strong>âœ… Correct Answer:</strong> "As a dual agent representing both parties, I cannot recommend a specific inspector. 
        ...
        <ul>
          <li>âŒ Recommending unqualified or unlicensed inspector</li>
          <li>âŒ Steering buyer to "easy" inspector who misses major defects</li>
          <li>âŒ Receiving kickbacks from inspector without disclosure</li>
          <li>âŒ Failing to provide "Facts for Consumers" brochure</li>
          <li>âŒ Recommending inspector when acting as listing/dual agent</li>
        </ul>

        <h4>Agent is Protected When:</h4>
        <ul>
          <li>âœ… Following the law's restrictions on recommendations</li>
          <li>âœ… Providing multiple inspector names (if buyer's agent)</li>
          <li>âœ… Disclosing any relationships with recommended inspectors</li>
          <li>âœ… Giving buyer freedom to choose any inspector</li>
          <li>âœ… Providing state resources and licensed inspector list</li>
          <li>âœ… Documenting that "Facts for Consumers" brochure was provided</li>
        </ul>
    ...
    body: (
      <>
        ...
        <div className="event-types">
          ...
          <ul>
            <li>ðŸ”ª <strong>Murder or Homicide:</strong> Death by violence on the property</li>
            <li>ðŸ’Š <strong>Drug Lab:</strong> Property used for manufacturing illegal drugs (meth lab, etc.)</li>
            <li>ðŸš” <strong>Felony:</strong> Serious crimes committed on premises</li>
            <li>âš ï¸ <strong>Gang-Related Activity:</strong> Gang operations or violence</li>
          </ul>

          <h4>Death-Related Events:</h4>
          <ul>
            <li>ðŸ’” <strong>Suicide:</strong> Self-inflicted death on property</li>
            <li>âš°ï¸ <strong>Natural Death:</strong> Death from natural causes (if recent or disturbing)</li>
            <li>ðŸ©º <strong>Unattended Death:</strong> Body not discovered for extended period</li>
          </ul>

          <h4>Other Stigmatizing Factors:</h4>
          <ul>
            <li>ðŸ‘» <strong>Haunted/Paranormal:</strong> Claims of ghosts, spirits, paranormal activity</li>
            <li>ðŸ˜± <strong>Notorious Resident:</strong> Former occupant was infamous criminal or celebrity</li>
            <li>ðŸšï¸ <strong>Site of Tragedy:</strong> Fire with fatalities, natural disaster deaths</li>
            <li>ðŸ˜¨ <strong>Sex Offender Nearby:</strong> Registered sex offender living close by</li>
            <li>â˜£ï¸ <strong>Contamination Concerns:</strong> Prior biological/chemical contamination (even if remediated)</li>
          </ul>
        </div>
        ...
        <div className="ma-law">
          ...
          <ul>
            <li>âœ… <strong>If asked directly:</strong> Seller & Agent MUST answer truthfully</li>
            <li>âœ… <strong>Cannot lie:</strong> If buyer asks "has anyone died here?" you must tell the truth</li>
            <li>âŒ <strong>No duty to investigate:</strong> Not required to research property history</li>
            <li>âŒ <strong>No duty to volunteer:</strong> Not required to bring it up if not asked</li>
            <li>âš ï¸ <strong>Cannot mislead:</strong> Cannot make false statements to cover up events</li>
          </ul>
        </div>
        ...
        <ul>
          <li>âœ… Answer truthfully if directly asked about stigmatizing events</li>
          <li>âœ… Disclose known information if specifically questioned</li>
          <li>âœ… Not make false or misleading statements</li>
          <li>âœ… Document that buyer asked (or didn't ask) about property history</li>
          <li>âœ… Recommend buyer do their own research if concerned</li>
        </ul>

        <h4>What You Are NOT Required to Do:</h4>
        <ul>
          <li>âŒ Volunteer information about deaths or crimes without being asked</li>
          <li>âŒ Research property history for stigmatizing events</li>
          <li>âŒ Investigate rumors or paranormal claims</li>
          <li>âŒ Check police records or death certificates</li>
          <li>âŒ Ask seller about every possible stigmatizing event</li>
        </ul>

        <h4>What You CANNOT Do:</h4>
        <ul>
          <li>ðŸš« Lie or misrepresent when asked directly</li>
          <li>ðŸš« Hide known information when specifically questioned</li>
          <li>ðŸš« Tell buyer "nothing happened here" if you know otherwise</li>
          <li>ðŸš« Make up stories or cover up events</li>
          <li>ðŸš« Discourage buyer from asking questions</li>
        </ul>
        ...
        <div className="example-scenario">
          ...
          <p><strong>If Asked Specifically:</strong> "How did they die?" â†’ Must answer: "It was a suicide."</p>
        </div>
        ...
        <div className="megans-law">
          ...
          <div className="risk-levels">
            ...
            <div className="risk-level-2">
              <h5>ðŸ“™ Level 2 - Moderate Risk</h5>
              <ul>
                ...
                <li><strong>âš ï¸ Note:</strong> Level 2 and 3 offenders are PUBLICLY AVAILABLE online</li>
              </ul>
            </div>

            <div className="risk-level-3">
              <h5>ðŸ“• Level 3 - High Risk</h5>
              <ul>
                ...
                <li><strong>ðŸš¨ Alert:</strong> Law enforcement actively notifies community</li>
              </ul>
            </div>
          </div>
          ...
          <ul>
            <li>âœ… <strong>Can Direct to Database:</strong> "You can search the public sex offender registry at [state website]"</li>
            <li>âœ… <strong>Can Acknowledge It's Public:</strong> "Sex offender information is public knowledge available online"</li>
            <li>âœ… <strong>Should Recommend Research:</strong> Suggest buyers research if they have concerns</li>
            <li>âŒ <strong>NOT Required to Research:</strong> You don't have to check the registry for every property</li>
            <li>âŒ <strong>NOT Required to Volunteer:</strong> Don't have to tell buyer "there's an offender 3 blocks away"</li>
            <li>âš ï¸ <strong>If Asked:</strong> Must answer truthfully if you have knowledge (but can admit you don't know)</li>
          </ul>
          ...
          <ul>
            <li>ðŸ“ <strong>Register Address:</strong> Where they live (and update within days if they move)</li>
            <li>ðŸ¢ <strong>Register Workplace:</strong> Where they work or go to school</li>
            <li>ðŸ“¸ <strong>Provide Photo:</strong> Recent photograph for database</li>
            <li>ðŸ”„ <strong>Update Regularly:</strong> Annual or more frequent verification</li>
            <li>âš ï¸ <strong>Failure to Register:</strong> Criminal offense with serious penalties</li>
          </ul>

          <h4>Accessing the Registry (Recommend to Buyers):</h4>
          <ul>
            <li>ðŸŒ <strong>Massachusetts:</strong> Mass.gov Sex Offender Registry Board (SORB)</li>
            <li>ðŸ—ºï¸ <strong>Search by Address:</strong> Enter property address to see offenders nearby</li>
            <li>ðŸ“± <strong>Mobile Apps:</strong> Various apps available for smartphone alerts</li>
            <li>ðŸ” <strong>National:</strong> National Sex Offender Public Website (NSOPW.gov)</li>
            <li>ðŸ“§ <strong>Email Alerts:</strong> Some states offer notification services</li>
          </ul>
        ...
        <div className="buyer-research">
          ...
          <ul>
            <li>ðŸ” <strong>Public Records:</strong> Police reports, court records, death certificates</li>
            <li>ðŸ“° <strong>News Archives:</strong> Search property address in local news databases</li>
            <li>ðŸ˜ï¸ <strong>Neighborhood Canvassing:</strong> Talk to neighbors about property history</li>
            <li>ðŸ’» <strong>Online Databases:</strong> 
              <ul>
            ...
            <li>ðŸ›ï¸ <strong>Town Hall:</strong> Building permits, violations, code enforcement history</li>
            <li>ðŸ—£ï¸ <strong>Ask Directly:</strong> "Has anyone died here? Any crimes? Paranormal activity?"</li>
          </ul>
        </div>
        ...
        <div className="value-impact">
          ...
          <ul>
            <li>ðŸ“‰ <strong>2-10% less</strong> than comparable non-stigmatized properties</li>
            <li>ðŸ“‰ <strong>10-25% less</strong> for well-publicized violent crimes</li>
            <li>ðŸ“‰ <strong>15-35% less</strong> for notorious cases (celebrity murders, serial killers)</li>
            <li>ðŸ’€ <strong>Infamous properties</strong> can be nearly unmarketable</li>
          </ul>
        ...
        <div className="seller-strategies">
          ...
          <ul>
            <li>ðŸ’° <strong>Price Accordingly:</strong> Expect lower market value</li>
            <li>ðŸ”¨ <strong>Renovate:</strong> Change layout, paint, flooring where event occurred</li>
            <li>â° <strong>Wait:</strong> Stigma lessens with time (sometimes years needed)</li>
            <li>ðŸ“‹ <strong>Full Disclosure:</strong> Some sellers proactively disclose to avoid issues</li>
            <li>ðŸŽ¯ <strong>Target Market:</strong> Investors less affected by stigma than owner-occupants</li>
            <li>ðŸ“„ <strong>Written Disclosure:</strong> Consider disclosure even if not required (protects from future claims)</li>
          </ul>
        </div>
        ...
        <div className="liability-warning">
          <ul>
            <li>ðŸš¨ <strong>Fraud:</strong> Lying when directly asked about stigmatizing events</li>
            <li>ðŸš¨ <strong>Misrepresentation:</strong> Making false statements to cover up history</li>
            <li>ðŸš¨ <strong>Failure to Disclose:</strong> If asked specifically and you don't answer truthfully</li>
            <li>ðŸš¨ <strong>Active Concealment:</strong> Deliberately hiding known information when questioned</li>
          </ul>
        </div>

        <h4>Agent is NOT Liable For:</h4>
        <ul>
          <li>âœ… Not volunteering information about stigmatizing events</li>
          <li>âœ… Not researching property history for past events</li>
          <li>âœ… Unknown stigmatizing events (no duty to investigate)</li>
          <li>âœ… Buyer's failure to ask about property history</li>
        </ul>
        ...
        <div className="sample-language">
          ...
          <p><strong>âœ… Good Response:</strong> "To the best of my knowledge, [state the facts]. I recommend you research public records if you'd like more detailed information."</p>
          <p><strong>âŒ Bad Response:</strong> "Nothing happened here that you need to worry about." (Misleading)</p>
          
          <h4>When You Don't Know:</h4>
          <p><strong>âœ… Good Response:</strong> "I don't have personal knowledge of any such events, but I'm not required to investigate. Public records are available if you'd like to research further."</p>
          
          <h4>When Seller Hasn't Disclosed to You:</h4>
          <p><strong>âœ… Good Response:</strong> "The seller hasn't disclosed any such events to me. You may want to ask the seller directly and/or check public records."</p>

          <h4>When Recommending Research:</h4>
          <p><strong>âœ… Good Response:</strong> "Property history research is available through public records, news archives, and online databases. I can provide the property address and timeline if you'd like to investigate."</p>
        </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>âœ… Use 3-6 comparable sales minimum</li>
          <li>âœ… Keep comps within 1 mile and 6 months when possible</li>
          <li>âœ… Adjust for market conditions (appreciation/depreciation)</li>
          <li>âœ… Weight the most similar comps more heavily</li>
          <li>âœ… Consider days on market and list-to-sale price ratios</li>
          <li>âŒ Don't use comps from different school districts unless necessary</li>
          <li>âŒ Don't cherry-pick comps to support desired price</li>
        </ul>

        <h4>ðŸ“Š CMA as "Opinion of Value" - Critical Understanding</h4>
        <div className="cma-opinion-section">
          ...
          <p className="highlight">
            <strong>âš ï¸ Key Point:</strong> A CMA varies depending on the <strong>skill & experience of the agent</strong>. 
            Not all CMAs are created equal! An experienced agent with deep market knowledge will produce more accurate valuations.
          </p>
          
          <h5>ðŸ” The CMA Looks at the Following Data:</h5>
          <div className="cma-data-points">
            <div className="data-point">
              <h6>âœ… Recent <em>comparable sales</em></h6>
              <ul>
            ...
            <div className="data-point">
              <h6>âœ… <em>Current Inventory</em></h6>
              <ul>
            ...
            <div className="data-point">
              <h6>âœ… <em>Expired or Withdrawn Inventory (homes that didn't sell)</em></h6>
              <ul>
            ...
            <div className="data-point">
              <h6>âœ… <em>Current & future market conditions</em></h6>
              <ul>
          ...
          <h5>ðŸ”§ Making Adjustments - Negative / Positive</h5>
          <p className="highlight">
          ...
          <h5>ðŸ’» CMA Software & Programs</h5>
        ...
        <h4>ðŸ“‹ Listing Presentation: Comparable Sales & Beyond</h4>
        <div className="listing-presentation">
          ...
          <ol>
            <li><strong>ðŸ“Š Comparable Sales & Adjustments</strong>
              <ul>
            ...
            <li><strong>ðŸ“ˆ Marketing Plan</strong>
              <ul>
            ...
            <li><strong>ðŸ“„ Your Resume</strong>
              <ul>
            ...
            <li><strong>ðŸ’¬ Professional References</strong>
              <ul>
            ...
            <li><strong>ðŸ“® Examples of Marketing Materials</strong>
              <ul>
          ...
          <div className="presentation-tips">
            <h5>ðŸŽ¯ Listing Presentation Success Tips:</h5>
            <p className="warning">
              <strong>"What makes you different???? It's NOT WHAT YOU THINK THEY WANT TO HEAR! (DO AT HOME)"</strong>
            </p>
            <ul>
              <li><strong>âŒ Don't:</strong> Tell them what you THINK they want to hear</li>
              <li><strong>âŒ Don't:</strong> Overpromise on list price to win listing</li>
              <li><strong>âŒ Don't:</strong> Use generic, templated presentations</li>
              <li><strong>âŒ Don't:</strong> Focus only on YOUR accomplishments</li>
              <li><strong>âœ… Do:</strong> Ask questions about THEIR goals and concerns</li>
              <li><strong>âœ… Do:</strong> Listen more than you talk</li>
              <li><strong>âœ… Do:</strong> Be honest about realistic pricing (even if it's lower than they hope)</li>
              <li><strong>âœ… Do:</strong> Customize presentation to their specific property and situation</li>
              <li><strong>âœ… Do:</strong> Show data, not opinions</li>
              <li><strong>âœ… Do:</strong> Explain your strategy for THEIR home, not just your general approach</li>
            </ul>
        ...
        <h4>ðŸ“¸ BPO (Broker Price Opinion) - Different from CMA</h4>
        <div className="bpo-section">
          ...
          <h5>âš ï¸ BPO Important Notes:</h5>
          <ul>
        ...
        <ol>
          ...
          <li><strong>Calculate Replacement Cost:</strong> Construction cost per square foot Ã— size</li>
        ...
        <ul>
          <li>âœ… New construction (little to no depreciation)</li>
          <li>âœ… Unique properties (churches, schools, special-use)</li>
          <li>âœ… Insurance valuations</li>
          <li>âœ… Properties with few comparables</li>
          <li>âŒ NOT ideal for older properties (depreciation hard to quantify)</li>
          <li>âŒ NOT ideal for standard residential (CMA is better)</li>
        </ul>
        ...
        <div className="formula">
          <p><strong>Net Operating Income (NOI) Ã· Capitalization Rate = Property Value</strong></p>
        </div>

        <h4>Calculating Net Operating Income (NOI):</h4>
        <div className="calculation-steps">
          <p>Gross Potential Rent (all units at market rent)</p>
          <p>âˆ’ Vacancy Loss (5-10% typical)</p>
          <p>= Effective Gross Income</p>
          <p>âˆ’ Operating Expenses (NOT including mortgage)</p>
        ...
        <ul>
          <li>âŒ Mortgage payments (debt service)</li>
          <li>âŒ Depreciation (accounting, not cash)</li>
          <li>âŒ Income taxes (investor-specific)</li>
          <li>âŒ Capital improvements (one-time, not recurring)</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Example:</strong> $50,000 NOI Ã· 6% cap rate = $833,333 value</li>
        </ul>

        <h4>When to Use Income Approach:</h4>
        <ul>
          <li>âœ… Multi-family properties (3+ units)</li>
          <li>âœ… Commercial real estate</li>
          <li>âœ… Investment properties</li>
          <li>âœ… Rent-producing properties</li>
          <li>âŒ NOT for owner-occupied single-family (no income)</li>
        </ul>
        ...
        <div className="warning-box">
          ...
          <ul>
            <li>âš ï¸ No showings after 2-3 weeks</li>
            <li>âš ï¸ Priced 10%+ above recent comps</li>
            <li>âš ï¸ Days on market exceeding area average</li>
            <li>âš ï¸ No offers on well-marketed property</li>
            <li>âš ï¸ Price reductions not generating activity</li>
          </ul>

          <h4>Signs of Underpricing:</h4>
          <ul>
            <li>âš ï¸ Multiple offers within first week</li>
            <li>âš ï¸ Showings booked solid immediately</li>
            <li>âš ï¸ Offers well above asking price</li>
            <li>âš ï¸ Priced below recent comparable sales</li>
          </ul>
        </div>
        ...
        <div className="agent-role">
          ...
          <ul>
            <li>âœ… Provide comprehensive CMA with multiple comps</li>
            <li>âœ… Explain how you arrived at suggested price range</li>
            <li>âœ… Discuss market conditions and trends</li>
            <li>âœ… Set realistic expectations with data</li>
            <li>âœ… Recommend pricing strategy (aggressive vs. conservative)</li>
            <li>âœ… Update pricing recommendations as market shifts</li>
          </ul>

          <h4>What Agents CANNOT Do:</h4>
          <ul>
            <li>âŒ Guarantee a specific sale price</li>
            <li>âŒ Perform a formal appraisal (unless also licensed appraiser)</li>
            <li>âŒ Guarantee property will appraise at list price</li>
            <li>âŒ Overprice to "win" listing (unethical)</li>
            <li>âŒ Lowball to create quick sale for commission</li>
          </ul>
        </div>
    ...
    body: (
      <>
        ...
        <div className="loan-types-overview">
          ...
          <div className="loan-type-card">
            <h4>ðŸ“Š Adjustable Rate Mortgage (ARM)</h4>
        ...
        <p className="highlight">
          ...
          Match loan type to buyer profile: Veteransâ†’VA, Ruralâ†’USDA, Lower creditâ†’FHA, 
          Fixer-upperâ†’203K, Good creditâ†’Conventional. Always refer to licensed lender for specific qualification.
        </p>
        ...
        <h4>Advantages:</h4>
        <ul>
          <li>âœ… Lowest interest rates with good credit</li>
          <li>âœ… PMI drops off at 78% LTV (loan-to-value)</li>
          <li>âœ… Can be used for investment properties (higher down payment)</li>
          <li>âœ… Flexible terms (15, 20, 30 years)</li>
          <li>âœ… Fewer property requirements than FHA</li>
        </ul>

        <h4>Disadvantages:</h4>
        <ul>
          <li>âŒ Stricter credit requirements</li>
          <li>âŒ Larger down payment needed</li>
          <li>âŒ Tougher approval for self-employed</li>
        </ul>
        ...
        <div className="arm-component">
          ...
          <p className="warning"><strong>âš ï¸ Negative Amortization Risk:</strong> A rate increase could result in a 
        ...
        <ul>
          <li>âœ… <strong>Lower Initial Rate:</strong> Start 0.5-1% below fixed rates</li>
          <li>âœ… <strong>Lower Initial Payment:</strong> More affordable at first</li>
          <li>âœ… <strong>Rate May Decrease:</strong> If market rates fall, your rate falls</li>
          <li>âœ… <strong>Good for Short-Term:</strong> If selling/refinancing within fixed period</li>
          <li>âœ… <strong>Easier Qualification:</strong> Lower start rate = lower DTI</li>
        </ul>

        <h4>Disadvantages of ARMs:</h4>
        <ul>
          <li>âŒ <strong>Uncertainty:</strong> Don't know future payment amounts</li>
          <li>âŒ <strong>Payment Shock:</strong> Payments can increase significantly</li>
          <li>âŒ <strong>Negative Amortization:</strong> May owe more than borrowed</li>
          <li>âŒ <strong>Harder to Budget:</strong> Variable payments complicate planning</li>
          <li>âŒ <strong>Risk if Rates Rise:</strong> Could become unaffordable</li>
        </ul>

        <h4>When ARMs Make Sense:</h4>
        <ul>
          <li>ðŸ“ˆ <strong>Expect Income Increase:</strong> Can afford higher payments later</li>
          <li>ðŸ  <strong>Planning to Move:</strong> Within 5-7 years (before adjustments)</li>
          <li>ðŸ“‰ <strong>Rates Expected to Fall:</strong> Benefit from rate decreases</li>
          <li>ðŸ’¼ <strong>Short-Term Ownership:</strong> Not your forever home</li>
          <li>ðŸ”„ <strong>Plan to Refinance:</strong> Before adjustment period begins</li>
        </ul>

        <h4>When ARMs DON'T Make Sense:</h4>
        <ul>
          <li>ðŸ¡ <strong>Forever Home:</strong> Planning to stay 10+ years</li>
          <li>ðŸ’° <strong>Fixed Income:</strong> Retirees, can't afford increases</li>
          <li>ðŸ“Š <strong>Tight Budget:</strong> Can barely afford current payment</li>
          <li>ðŸ˜° <strong>Risk Averse:</strong> Need payment certainty</li>
          <li>ðŸ“ˆ <strong>Rates Low:</strong> When fixed rates are already low, lock in!</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>MIP Duration:</strong> Life of loan if &lt;10% down, 11 years if â‰¥10% down</li>
        </ul>
        ...
        <h4>Advantages:</h4>
        <ul>
          <li>âœ… Low down payment (3.5%)</li>
          <li>âœ… More lenient credit requirements</li>
          <li>âœ… Higher debt-to-income ratios accepted</li>
          <li>âœ… Assumable loans (buyer can take over loan)</li>
          <li>âœ… Gift funds allowed for down payment</li>
        </ul>

        <h4>Disadvantages:</h4>
        <ul>
          <li>âŒ MIP for life of loan (if &lt;10% down)</li>
          <li>âŒ Stricter property condition requirements</li>
          <li>âŒ Lower loan limits than conventional in some areas</li>
          <li>âŒ Longer closing times (more documentation)</li>
        </ul>
        ...
        <h4>Advantages:</h4>
        <ul>
          <li>âœ… No down payment required</li>
          <li>âœ… No PMI ever</li>
          <li>âœ… Competitive interest rates</li>
          <li>âœ… Seller can pay all buyer closing costs</li>
          <li>âœ… Lenient credit requirements</li>
          <li>âœ… Can use multiple times</li>
          <li>âœ… Assumable by qualified buyers</li>
        </ul>

        <h4>Disadvantages:</h4>
        <ul>
          <li>âŒ Funding fee (unless disabled)</li>
          <li>âŒ Must be primary residence</li>
          <li>âŒ Stricter property condition standards</li>
          <li>âŒ Some sellers hesitate (unfamiliar, longer closing)</li>
          <li>âŒ VA appraisal required (can be conservative)</li>
        </ul>
        ...
        <h4>Advantages:</h4>
        <ul>
          <li>âœ… No down payment</li>
          <li>âœ… Low mortgage insurance</li>
          <li>âœ… Competitive rates</li>
          <li>âœ… Seller can pay closing costs</li>
        </ul>

        <h4>Disadvantages:</h4>
        <ul>
          <li>âŒ Geographic restrictions</li>
          <li>âŒ Income limits</li>
          <li>âŒ Primary residence only</li>
          <li>âŒ Longer processing times</li>
        </ul>
        ...
        <h4>Advantages:</h4>
        <ul>
          <li>âœ… Allows purchase of higher-priced homes</li>
          <li>âœ… No PMI if 20% down</li>
          <li>âœ… Competitive rates (if strong financials)</li>
        </ul>

        <h4>Disadvantages:</h4>
        <ul>
          <li>âŒ Higher interest rates than conforming</li>
          <li>âŒ Larger down payment</li>
          <li>âŒ Stricter qualification requirements</li>
          <li>âŒ More documentation</li>
          <li>âŒ Fewer lenders offer jumbo loans</li>
        </ul>
        ...
        <div className="amortization-visual">
          <h5>ðŸ”‘ Key Insight: The 50/50 Milestone</h5>
          <p className="info">
          ...
          <ul>
            <li>ðŸ’° <strong>Equity Build:</strong> You build equity slowly at first, faster later</li>
            <li>ðŸ“Š <strong>Interest Costs:</strong> Most interest is paid in early years</li>
            <li>ðŸ  <strong>Refinancing Timing:</strong> Refinancing early means starting the cycle over</li>
            <li>ðŸ’µ <strong>Extra Payments:</strong> Extra principal payments early have biggest impact</li>
            <li>ðŸ“ˆ <strong>15-Year vs 30-Year:</strong> 15-year loans reach 50/50 split around year 10</li>
          </ul>
        </div>
        ...
        <ul>
          ...
          <li><strong>Round Up Payments:</strong> $2,528 â†’ $2,600 = big difference over time</li>
        </ul>
        ...
        <div className="comparison">
          ...
          <ul>
            ...
            <li>âŒ Not taken seriously by sellers</li>
          </ul>
          ...
          <ul>
            ...
            <li>âœ… Shows buyer is serious and qualified</li>
          </ul>
        </div>
        ...
        <div className="agent-role">
          <h4>What Agents SHOULD Do:</h4>
          <ul>
            <li>âœ… Recommend buyers get pre-approved before house hunting</li>
            <li>âœ… Refer to 2-3 reputable lenders</li>
            <li>âœ… Explain difference between loan types</li>
            <li>âœ… Review pre-approval letters for strength</li>
            <li>âœ… Coordinate with lender during transaction</li>
            <li>âœ… Monitor financing contingency deadlines</li>
            <li>âœ… Help buyer understand closing costs</li>
          </ul>

          <h4>What Agents CANNOT Do:</h4>
          <ul>
            <li>âŒ Guarantee loan approval</li>
            <li>âŒ Give specific financial advice</li>
            <li>âŒ Calculate exact loan qualifications</li>
            <li>âŒ Recommend specific loan products</li>
            <li>âŒ Accept kickbacks from lenders (RESPA violation)</li>
            <li>âŒ Pressure buyer to use specific lender</li>
          </ul>
        </div>
        ...
        <h4>ðŸ“‹ What Lenders MUST Do Under Dodd-Frank:</h4>
        ...
        <ul>
          <li>ðŸ  <strong>Know Your Buyers' Rights:</strong> Educate clients about lender obligations</li>
          <li>ðŸ“ž <strong>Spot Red Flags:</strong> If buyer reports lender not following rules, refer to attorney</li>
          <li>â° <strong>Timeline Awareness:</strong> Understand 120-day pre-foreclosure timeline</li>
          <li>ðŸ’¼ <strong>Loss Mitigation:</strong> Know alternatives to foreclosure (short sale, modification)</li>
          <li>ðŸ“‹ <strong>Documentation:</strong> Encourage buyers to keep all lender communications</li>
          <li>âš–ï¸ <strong>Complaint Process:</strong> Know where to direct borrowers (CFPB - Consumer Financial Protection Bureau)</li>
        </ul>
        ...
        <p className="warning">
          <strong>âš ï¸ Agent Responsibility:</strong> While you can't give legal advice, you should know these 
        ...
        <div className="fed-tools">
          <h5>1ï¸âƒ£ RESERVE REQUIREMENTS</h5>
          ...
          <ul>
            <li><strong>Increase reserve requirements:</strong>
              <ul>
                ...
                <li>Opposite: decreases reserve â†’ allows more money to be loaned in marketplace</li>
          ...
          <h5>3ï¸âƒ£ OPEN MARKET ACTIVITIES</h5>
        ...
        <ul>
          <li>ðŸ“ˆ <strong>Maximum Employment:</strong> Keep unemployment low</li>
          <li>ðŸ’° <strong>Price Stability:</strong> Keep inflation around 2% target</li>
        </ul>
        ...
        <div className="agent-fed-knowledge">
          ...
          <h5>ðŸ“ˆ Economic Indicators to Watch:</h5>
          <ul>
        ...
        <ul>
          ...
          <li><strong>2022-2023:</strong> Aggressive rate increases (0% â†’ 5.25-5.5%) to fight inflation</li>
          <li><strong>Impact:</strong> Mortgage rates went from 3% to 7%+ in 18 months</li>
        </ul>

        <h4>Fed vs. Mortgage Rates:</h4>
        <p className="warning">
          <strong>âš ï¸ Important Distinction:</strong> The Fed does NOT directly set mortgage rates. The Fed sets 
        ...
        <div className="lender-types">
          <h4>1ï¸âƒ£ Savings Associations (Thrifts)</h4>
          ...
          <h4>2ï¸âƒ£ Mutual Savings Banks</h4>
          ...
          <h4>4ï¸âƒ£ Insurance Companies</h4>
          ...
          <h4>5ï¸âƒ£ Mortgage Banking Companies (Direct Lenders)</h4>
          ...
          <ul>
            <li>ðŸ’° <strong>Origination Fees:</strong> Points and fees at closing</li>
            <li>ðŸ’° <strong>Servicing Fees:</strong> Monthly fee (typically 0.25-0.5% annually)</li>
            <li>ðŸ’° <strong>Sale Premium:</strong> Profit from selling loans above par</li>
          </ul>

          <h4>6ï¸âƒ£ Mortgage Brokers (NOT Lenders)</h4>
          <p className="warning"><strong>âš ï¸ IMPORTANT:</strong> Mortgage brokers are NOT lenders - they are licensed 
          ...
          <h4>9ï¸âƒ£ Other Sources of Funds</h4>
          ...
          <h4>ðŸ”Ÿ Loan Servicing</h4>
          <p><strong>What it is:</strong> Lenders who sell of loan tend to hold onto the servicing to make 
          additional money.</p>
          
          <h5>What Servicers Do:</h5>
          <ul>
            <li>ðŸ“§ <strong>Collecting Monthly Payments:</strong> Process borrower payments</li>
            <li>ðŸ¦ <strong>Holding Insurance and Tax Escrows:</strong> Manage escrow accounts</li>
            <li>ðŸ’° <strong>Making Escrow Payments:</strong> Pay property taxes and insurance</li>
            <li>ðŸ“® <strong>Sending Out Notices:</strong> Annual statements, tax forms</li>
            <li>ðŸ“ž <strong>Customer Service:</strong> Answer borrower questions</li>
            <li>âš ï¸ <strong>Default Management:</strong> Work with delinquent borrowers</li>
          </ul>
          ...
          <p className="example"><strong>Example:</strong> $300K loan serviced at 0.375% = $1,125/year Ã— 30 years = 
        ...
        <ul>
          <li>ðŸ¦ <strong>Lender Relationships:</strong> Build network with various lender types</li>
          <li>ðŸ’¡ <strong>Client Guidance:</strong> Recommend appropriate lender for situation</li>
          <li>âš¡ <strong>Speed:</strong> Credit unions may be slower, mortgage bankers faster</li>
          <li>ðŸ’° <strong>Rates:</strong> Credit unions often have best rates, brokers shop around</li>
          <li>ðŸ“‹ <strong>Underwriting:</strong> Different lenders have different flexibility</li>
          <li>ðŸŽ¯ <strong>Specialization:</strong> Some focus on FHA/VA, others conventional</li>
        </ul>
        ...
        <ul>
          <li>ðŸ’° <strong>Liquidity:</strong> Frees up lender capital to make more loans</li>
          <li>ðŸ¦ <strong>More Availability:</strong> Increases mortgage availability nationwide</li>
          <li>ðŸ“‰ <strong>Lower Rates:</strong> Competition keeps rates lower</li>
          <li>ðŸ“Š <strong>Standardization:</strong> Creates uniform lending standards</li>
          <li>ðŸ”„ <strong>Risk Distribution:</strong> Spreads risk among many investors</li>
        </ul>

        <h4>3 MAJOR INVESTORS IN SECONDARY MORTGAGE MARKET:</h4>
        
        <div className="secondary-market-investors">
          <h5>1ï¸âƒ£ Federal National Mortgage Association (FNMA or "Fannie Mae")</h5>
          <div className="investor-box">
            ...
            <ul>
              <li>âœ… Purchases conventional mortgages from lenders</li>
              <li>âœ… Purchases FHA-insured loans</li>
              <li>âœ… Packages loans into mortgage-backed securities (MBS)</li>
              <li>âœ… Sells MBS to investors worldwide</li>
              <li>âœ… Sets conforming loan limits (2025: $766,550 standard)</li>
              <li>âœ… Provides mortgage guidelines lenders must follow</li>
            </ul>
          ...
          <h5>2ï¸âƒ£ Government National Mortgage Association (GNMA or "Ginnie Mae")</h5>
          <div className="investor-box">
            ...
            <ul>
              <li>âœ… Purchases FHA-insured mortgages</li>
              <li>âœ… Purchases VA-guaranteed mortgages</li>
              <li>âœ… Guarantees mortgage-backed securities</li>
              <li>âœ… Does NOT buy conventional loans</li>
              <li>âœ… Provides government backing to investors</li>
              <li>âœ… Lowest risk MBS available (government guarantee)</li>
            </ul>
          ...
          <h5>3ï¸âƒ£ Federal Home Loan Mortgage Corporation (FHLMC or "Freddie Mac")</h5>
          <div className="investor-box">
            ...
            <ul>
              <li>âœ… Purchases conventional mortgages from lenders</li>
              <li>âœ… Particularly focuses on smaller lenders (credit unions, community banks)</li>
              <li>âœ… Packages loans into mortgage-backed securities</li>
              <li>âœ… Provides stability to mortgage market</li>
              <li>âœ… Follows same conforming loan limits as Fannie Mae</li>
            </ul>
        ...
        <ul>
          <li>ðŸ“‹ <strong>Conforming Limits:</strong> Fannie/Freddie set the conforming loan limits you'll reference daily</li>
          <li>ðŸ’° <strong>Loan Eligibility:</strong> Understand which loans qualify for secondary market (better rates)</li>
          <li>ðŸ¦ <strong>Lender Confidence:</strong> Loans that meet Fannie/Freddie standards close more reliably</li>
          <li>ðŸ“Š <strong>Market Impact:</strong> Secondary market changes affect buyer purchasing power</li>
          <li>âš¡ <strong>Rate Movements:</strong> MBS trading affects daily mortgage rate changes</li>
          <li>ðŸŽ¯ <strong>Guidelines:</strong> Fannie/Freddie underwriting guidelines become lender requirements</li>
        </ul>
        ...
        <p className="warning">
          <strong>âš ï¸ Important:</strong> While lenders interact directly with these entities, your clients will 
    ...
    body: (
      <>
        ...
        <div className="important-note">
          <h4>âš ï¸ Critical Mortgage Terms to Understand:</h4>
          ...
          <p className="warning"><strong>âš ï¸ Important:</strong> Money advanced by lender will be due immediately 
          from borrower or added to unpaid debt.</p>
        </div>

        <div className="important-note">
          <h4>ðŸ’° Usury & Prepayment</h4>
          
          <h5>USURY:</h5>
          <p><strong>Definition:</strong> Maximum interest rates that may be charged on loans are set by state laws.</p>
          <p className="warning"><strong>âš ï¸ Violation:</strong> Charging rates in excess of this rate is called 
        ...
        <div className="important-note">
          <h4>ðŸ“ Additional Mortgage Clauses</h4>
          ...
          <h5>Why This Matters:</h5>
          <ul>
            <li>ðŸ¦ <strong>Secondary Market:</strong> Most mortgages are sold after origination</li>
            <li>ðŸ’° <strong>Liquidity:</strong> Allows lenders to make more loans</li>
            <li>ðŸ“§ <strong>Same Servicer:</strong> You often keep paying the same company</li>
            <li>ðŸ“„ <strong>Terms Unchanged:</strong> Your loan terms remain the same</li>
          </ul>
          ...
          <h5>Why This Matters:</h5>
          <ul>
            <li>âš–ï¸ <strong>Waives Defense:</strong> Can't later claim loan terms were different</li>
            <li>ðŸ”’ <strong>Locked In:</strong> Protects the new lender/investor</li>
            <li>ðŸ“‹ <strong>May Require Signature:</strong> Some require Estoppel Certificate</li>
            <li>ðŸ’¼ <strong>Commercial Common:</strong> More common in commercial real estate</li>
          </ul>
          ...
          <h5>Why This Matters:</h5>
          <ul>
            <li>ðŸ—ï¸ <strong>Development:</strong> Critical for subdivisions and land development</li>
            <li>ðŸ“Š <strong>Phased Release:</strong> Sell individual lots while keeping blanket mortgage</li>
            <li>ðŸ’µ <strong>Payment Required:</strong> Usually requires payment to release each parcel</li>
            <li>ðŸ”‘ <strong>Developer Tool:</strong> Allows progressive sale of development parcels</li>
          </ul>
          ...
          <h5>Why This Matters:</h5>
          <ul>
            <li>ðŸ’° <strong>Protects Lender:</strong> Ensures current market interest rates apply</li>
            <li>ðŸ  <strong>No Assumption:</strong> Buyer can't take over seller's low-interest loan</li>
            <li>ðŸ“ˆ <strong>Rate Protection:</strong> If rates increased, lender doesn't lose money</li>
            <li>âš ï¸ <strong>Must Pay Off:</strong> Seller must pay off loan at closing (from sale proceeds)</li>
            <li>ðŸ”„ <strong>Standard Today:</strong> Nearly all modern mortgages have this clause</li>
          </ul>
        ...
        <div className="important-note">
          ...
          <p className="warning"><strong>âš ï¸ Requires:</strong> The note holder or "investors" approval.</p>
          ...
          <ul>
            <li>ðŸ“‹ <strong>Financial Hardship:</strong> Job loss, medical bills, divorce, etc.</li>
            <li>ðŸ’¼ <strong>Lender Approval:</strong> Must approve both price and buyer</li>
            <li>ðŸ“„ <strong>Documentation:</strong> Extensive financial paperwork required</li>
            <li>â±ï¸ <strong>Long Process:</strong> 3-6 months typical (lender review time)</li>
            <li>ðŸ’° <strong>No Proceeds:</strong> Seller gets nothing, just avoids foreclosure</li>
          </ul>
          ...
          <ul>
            <li>âœ… <strong>Specialized Knowledge:</strong> Short sales require expertise</li>
            <li>âœ… <strong>Lender Negotiation:</strong> Work with lender's loss mitigation department</li>
            <li>âœ… <strong>Manage Expectations:</strong> Buyers must be patient (long process)</li>
            <li>âœ… <strong>Documentation:</strong> Help seller gather financial hardship docs</li>
            <li>âœ… <strong>Multiple Offers:</strong> Present strongest offer to lender</li>
            <li>âš ï¸ <strong>No Guarantee:</strong> Lender may reject even accepted offer</li>
          </ul>
        ...
        <div className="important-note">
          <h4>ðŸ“‹ Additional Financing Terms</h4>
          ...
          <ul>
            ...
            <li><strong>Typical balloon:</strong> $300,000 loan â†’ 7 years later owe $250,000+ in one payment</li>
          </ul>

          <h6>Why Balloon Payments Exist:</h6>
          <ul>
            <li>ðŸ’° <strong>Lower Payments:</strong> Monthly payments lower than fully amortized</li>
            <li>ðŸ¦ <strong>Seller Financing:</strong> Common in seller-financed deals</li>
            <li>ðŸ’¼ <strong>Commercial Loans:</strong> Standard in commercial real estate</li>
            <li>ðŸ”„ <strong>Assumption:</strong> Borrower expects to refinance or sell before balloon due</li>
          </ul>

          <h6>Balloon Payment Risks:</h6>
          <ul>
            <li>âš ï¸ <strong>Refinance Risk:</strong> What if rates are high when balloon due?</li>
            <li>ðŸ“‰ <strong>Value Risk:</strong> What if property value dropped? Can't refinance</li>
            <li>ðŸ’µ <strong>Must Pay:</strong> If can't refinance or sell, lose property</li>
            <li>ðŸšï¸ <strong>Foreclosure Risk:</strong> Many foreclosures happen at balloon date</li>
          </ul>
          ...
          <ul>
            <li>âŒ <strong>Missed Payments:</strong> Not paying monthly mortgage</li>
            <li>âŒ <strong>Late Payments:</strong> Consistently paying after due date</li>
            <li>âŒ <strong>Property Taxes:</strong> Not paying real estate taxes</li>
            <li>âŒ <strong>Insurance:</strong> Letting homeowner's insurance lapse</li>
            <li>âŒ <strong>Property Condition:</strong> Allowing property to deteriorate (waste)</li>
            <li>âŒ <strong>HOA Fees:</strong> Not paying condo/HOA fees</li>
          </ul>

          <h6>Consequences of Default:</h6>
          <p className="warning"><strong>Late payment fees & grace period given.</strong></p>
          <ul>
            <li>ðŸ’µ <strong>Late Fees:</strong> Typically 4-5% of payment amount</li>
            <li>ðŸ“… <strong>Grace Period:</strong> Usually 10-15 days after due date</li>
            <li>ðŸ“ž <strong>Collection Calls:</strong> Lender begins calling after 30 days</li>
            <li>ðŸ“‹ <strong>Demand Letter:</strong> Formal notice to cure default (60-90 days)</li>
            <li>âš–ï¸ <strong>Acceleration:</strong> Lender can call entire loan due</li>
            <li>ðŸšï¸ <strong>Foreclosure:</strong> Legal process to take property begins</li>
          </ul>
          ...
          <div className="foreclosure-type">
            <h5>1ï¸âƒ£ Judicial Foreclosure (Court Process):</h5>
          ...
          <div className="foreclosure-type">
            <h5>2ï¸âƒ£ Statutory Foreclosure (Power of Sale):</h5>
          ...
          <div className="ma-specific">
            <h5>ðŸ›ï¸ Massachusetts-Specific Foreclosure Rules</h5>

            <h6>Power of Sale Foreclosure in MA:</h6>
            <p className="highlight"><strong>â­ Commonly used in MA.</strong> Right to sell property at Auction.</p>
            ...
            <h6>âš”ï¸ Soldiers and Sailors Civil Relief Act (SCRA):</h6>
            ...
            <p className="warning"><strong>âš ï¸ CRITICAL MA RULE:</strong> In MA, right of redemption is terminated 
            ...
            <p className="warning"><strong>âš ï¸ Buyer Beware:</strong> Buying foreclosed property means accepting 
            ...
            <p className="warning"><strong>âš ï¸ MAJOR ISSUE:</strong> Conveyance is subject to ALL existing liens 
          ...
          <ul>
            <li>ðŸ’° <strong>Reinstatement:</strong> Pay all missed payments + fees to bring current</li>
            <li>ðŸ“ <strong>Forbearance:</strong> Temporary payment reduction/pause from lender</li>
            <li>ðŸ”„ <strong>Loan Modification:</strong> Permanently change loan terms</li>
            <li>ðŸ  <strong>Short Sale:</strong> Sell for less than owed (with lender approval)</li>
            <li>ðŸ¤ <strong>Deed in Lieu:</strong> Voluntarily give property back to lender</li>
            <li>âš–ï¸ <strong>Bankruptcy:</strong> Chapter 13 can stop foreclosure temporarily</li>
          </ul>

          <h6>Impact on Credit:</h6>
          <ul>
            <li>ðŸ“‰ <strong>Foreclosure:</strong> Drops credit 200-300+ points, stays 7 years</li>
            <li>ðŸ“‰ <strong>Short Sale:</strong> Drops credit 100-200 points, stays 7 years</li>
            <li>ðŸ“‰ <strong>Deed in Lieu:</strong> Similar to short sale impact</li>
            <li>ðŸ“‰ <strong>Bankruptcy:</strong> Drops credit 150-250 points, stays 7-10 years</li>
            <li>â±ï¸ <strong>Recovery Time:</strong> 3-7 years before qualifying for new mortgage</li>
          </ul>
        </div>

        <div className="important-note">
          <h4>ðŸ“š More Financing Terms to Know</h4>
          ...
          <p className="warning"><strong>âš ï¸ To be valid, both lenders must sign the agreement.</strong></p>
          ...
          <ul>
            <li>ðŸ¦ <strong>Lien Priority:</strong> Determines who gets paid first in foreclosure</li>
            <li>ðŸ’° <strong>Protects Lenders:</strong> New lender needs 1st position for better security</li>
            <li>ðŸ“‹ <strong>Both Must Sign:</strong> Subordinating lender must agree (may charge fee)</li>
            <li>ðŸ’µ <strong>Subordination Fee:</strong> Typically $200-$500 for 2nd lender to agree</li>
            <li>âš ï¸ <strong>May Refuse:</strong> 2nd lender can refuse if new loan too large or risky</li>
          </ul>
          ...
          <ul>
            ...
            <li><strong>Monthly payment:</strong> $1,500 (interest only: $300K Ã— 6% Ã· 12)</li>
          ...
          <h6>Advantages:</h6>
          <ul>
            <li>âœ… <strong>Lower Payments:</strong> Much lower than fully amortized loan</li>
            <li>âœ… <strong>Cash Flow:</strong> Frees up cash for other investments</li>
            <li>âœ… <strong>Tax Deduction:</strong> All payment is tax-deductible interest</li>
            <li>âœ… <strong>Short-Term:</strong> Good if planning to sell or refinance soon</li>
          </ul>

          <h6>Disadvantages:</h6>
          <ul>
            <li>âŒ <strong>No Equity Building:</strong> Principal never decreases</li>
            <li>âŒ <strong>Balloon Risk:</strong> Must pay entire principal at end</li>
            <li>âŒ <strong>Refinance Risk:</strong> What if can't refinance when due?</li>
            <li>âŒ <strong>Not Common:</strong> Few lenders offer for residential (more for commercial)</li>
          </ul>
          ...
          <ul>
            <li>ðŸ  <strong>Buying a Home:</strong> Shows property's claim history (water damage, fire, etc.)</li>
            <li>ðŸ’° <strong>Insurance Rates:</strong> Multiple claims = higher rates or denied coverage</li>
            <li>ðŸ” <strong>Red Flags:</strong> Frequent claims may indicate property problems</li>
            <li>ðŸ“‹ <strong>Disclosure:</strong> Seller should disclose major issues, CLUE verifies</li>
            <li>âš ï¸ <strong>Denied Coverage:</strong> Too many claims can make property uninsurable</li>
          </ul>
          ...
          <p className="warning"><strong>âš ï¸ CRITICAL:</strong> Payments postponed are not forgiven; rather, 
          ...
          <ul>
            <li>âœ… <strong>Financial Hardship:</strong> Job loss, medical emergency, natural disaster</li>
            <li>âœ… <strong>Government-Backed:</strong> FHA, VA, USDA loans have protections</li>
            <li>âœ… <strong>Conventional Loans:</strong> Fannie Mae/Freddie Mac also offer forbearance</li>
            <li>âœ… <strong>Private Loans:</strong> Must negotiate with lender (not guaranteed)</li>
            <li>â±ï¸ <strong>Apply Early:</strong> Don't wait until in default</li>
          </ul>
        ...
        <div className="important-note">
          ...
          <h5>Why This Matters:</h5>
          <ul>
            <li>ðŸ”“ <strong>Clear Title:</strong> Removes the lender's claim from your property</li>
            <li>ðŸ“„ <strong>Proves Ownership:</strong> Shows you own the property free and clear</li>
            <li>ðŸ’¼ <strong>Future Transactions:</strong> Required for refinancing or selling</li>
            <li>âš–ï¸ <strong>Legal Requirement:</strong> Lender must provide this document</li>
          </ul>
        </div>
        ...
        <div className="recording-info">
          ...
          <ul>
            <li>ðŸ“‹ <strong>Public Record:</strong> Anyone can search and find your mortgage</li>
            <li>ðŸ¦ <strong>Lien Priority:</strong> First recorded = first priority (if multiple liens)</li>
            <li>âš ï¸ <strong>Buyer Beware:</strong> Buyers are assumed to know about recorded liens</li>
            <li>ðŸ” <strong>Title Search Purpose:</strong> Finds all recorded encumbrances</li>
          </ul>
        ...
        <div className="example">
          ...
          <ul>
            ...
            <li>$7,300 Ã· 365 = $20/day</li>
            <li>$20 Ã— 77 days = $1,540</li>
        ...
        <ul>
          <li>âœ… Government-issued photo ID</li>
          <li>âœ… Certified check or wire confirmation (closing costs + down payment)</li>
          <li>âœ… Proof of homeowner's insurance</li>
          <li>âœ… Final walk-through checklist</li>
        </ul>

        <h4>What Seller Brings:</h4>
        <ul>
          <li>âœ… Government-issued photo ID</li>
          <li>âœ… All keys, garage openers, access codes</li>
          <li>âœ… Appliance manuals and warranties</li>
          <li>âœ… HOA documents and contacts</li>
          <li>âœ… Mailbox key</li>
        </ul>
        ...
        <ul>
          <li>âœ… Change locks (for security)</li>
          <li>âœ… Set up utilities in your name</li>
          <li>âœ… File deed with homestead exemption (MA property tax protection)</li>
          <li>âœ… Update mailing address (USPS, DMV, voter registration)</li>
          <li>âœ… Review first mortgage statement carefully</li>
          <li>âœ… Keep closing documents in safe place (7+ years)</li>
          <li>âœ… Save receipts for capital improvements (tax purposes)</li>
        </ul>

        <h4>Seller's Post-Closing Checklist:</h4>
        <ul>
          <li>âœ… Confirm mortgage payoff received by lender</li>
          <li>âœ… Cancel homeowner's insurance (after closing date)</li>
          <li>âœ… Forward mail to new address</li>
          <li>âœ… Transfer or cancel utilities</li>
          <li>âœ… Keep closing documents (capital gains calculation)</li>
          <li>âœ… Track moving expenses if relocating for work (may be deductible)</li>
        </ul>
        ...
        <div className="agent-role">
          ...
          <ul>
            <li>âœ… Coordinate with all parties</li>
            <li>âœ… Remind clients what to bring</li>
            <li>âœ… Confirm final walk-through completed</li>
            <li>âœ… Verify closing funds wired/certified</li>
            <li>âœ… Review Closing Disclosure with client</li>
          </ul>

          <h4>At Closing:</h4>
          <ul>
            <li>âœ… Attend to support client (optional but appreciated)</li>
            <li>âœ… Clarify any last questions</li>
            <li>âœ… Collect commission check (if not wired)</li>
            <li>âœ… Hand over keys and access items</li>
            <li>âœ… Congratulate and thank everyone</li>
          </ul>

          <h4>After Closing:</h4>
          <ul>
            <li>âœ… Send thank you notes</li>
            <li>âœ… Request reviews/testimonials</li>
            <li>âœ… Ask for referrals</li>
            <li>âœ… Stay in touch (holiday cards, market updates)</li>
            <li>âœ… Remind about homestead filing (MA)</li>
          </ul>
        </div>
    ...
    body: (
      <>
        ...
        <div className="basis-calculation">
          ...
          <p>âˆ’ Depreciation Claimed (investment only)</p>
          <p>= <strong>Adjusted Basis</strong></p>
          <p></p>
          <p><strong>Sale Price</strong></p>
          <p>âˆ’ Adjusted Basis</p>
          <p>âˆ’ Selling Costs (commission, attorney, repairs to sell)</p>
        ...
        <ul>
          <li>âŒ Missing 45-day identification deadline (no extensions EVER)</li>
          <li>âŒ Touching the proceeds (must use qualified intermediary)</li>
          <li>âŒ Buying personal residence (must be investment)</li>
          <li>âŒ Trading down in value (triggers partial tax)</li>
          <li>âŒ Taking cash out ("boot" is taxable)</li>
          <li>âŒ Not including debt (new mortgage must be equal or greater)</li>
        </ul>
        ...
        <div className="example">
          ...
          <p><strong>Annual Depreciation:</strong> $450k Ã· 27.5 = $16,364/year</p>
          <p><strong>Monthly Depreciation:</strong> $1,364/month</p>
          <p><strong>Tax Savings:</strong> $16,364 Ã— 24% tax bracket = $3,927/year</p>
        </div>
        ...
        <ul>
          <li>âŒ Homeowners insurance</li>
          <li>âŒ HOA fees</li>
          <li>âŒ Utilities</li>
          <li>âŒ Repairs and maintenance</li>
          <li>âŒ Principal payments on mortgage</li>
          <li>âŒ Moving expenses (eliminated 2018-2025, except military)</li>
        </ul>
        ...
        <div className="rental-deductions">
          <ul>
            <li>âœ… Mortgage interest (no $750k cap)</li>
            <li>âœ… Property taxes (no $10k cap)</li>
            <li>âœ… Insurance (property, liability, landlord)</li>
            <li>âœ… Repairs and maintenance</li>
            <li>âœ… Property management fees</li>
            <li>âœ… Utilities (if owner-paid)</li>
            <li>âœ… Advertising for tenants</li>
            <li>âœ… Legal and professional fees</li>
            <li>âœ… HOA fees</li>
            <li>âœ… Pest control</li>
            <li>âœ… Landscaping</li>
            <li>âœ… Snow removal</li>
            <li>âœ… Depreciation (building + appliances)</li>
            <li>âœ… Travel to property (mileage or actual)</li>
            <li>âœ… Home office (if exclusive rental business use)</li>
            <li>âœ… Continuing education (landlord courses)</li>
            <li>âœ… Software/apps (property management tools)</li>
            <li>âœ… Supplies (cleaning, repairs)</li>
          </ul>
        </div>
        ...
        <div className="agent-role-tax">
          <h4>What Agents CAN Do:</h4>
          <ul>
            <li>âœ… Mention tax implications generally ("Many sellers qualify for capital gains exclusion")</li>
            <li>âœ… Recommend client consult CPA/tax professional</li>
            <li>âœ… Explain 1031 exchange EXISTS (not how to do it)</li>
            <li>âœ… Provide referrals to tax professionals (no kickbacks)</li>
            <li>âœ… Help track capital improvements for basis calculation</li>
            <li>âœ… Explain closing cost deductions in general</li>
          </ul>

          <h4>What Agents CANNOT Do:</h4>
          <ul>
            <li>âŒ Calculate capital gains tax</li>
            <li>âŒ Advise which deductions client qualifies for</li>
            <li>âŒ Interpret tax law</li>
            <li>âŒ Complete any tax forms</li>
            <li>âŒ Guarantee tax treatment</li>
            <li>âŒ Give specific 1031 exchange advice</li>
            <li>âŒ Determine if client is real estate professional</li>
          </ul>
        </div>
    ...
    body: (
      <>
        ...
        <p className="highlight">
          ...
          <br />
          â€¢ Civil fines up to $1 million per violation
          <br />
          â€¢ Criminal prosecution (up to $100 million for corporations)
          <br />
          â€¢ Treble damages (3x actual damages) in private lawsuits
          <br />â€¢ License suspension or revocation
        </p>

        <h3>11.2 Massachusetts Association of REALTORSÂ® (MAR)</h3>
        <p>
        ...
        <h3>11.3 National Association of REALTORSÂ® (NAR)</h3>
        <p>
          The largest trade association in the United States, representing 1.5+ million members
          nationwide.
        </p>

        <h4>REALTORÂ® vs. Real Estate Agent</h4>
        <ul>
          <li>
            <strong>Real Estate Agent:</strong> Anyone with an active real estate license
          </li>
          <li>
            <strong>REALTORÂ®:</strong> Licensed agent who is a NAR member and follows the Code of Ethics
          </li>
          <li>
            <strong>Trademark:</strong> REALTORÂ® is a registered trademark; only members can use it
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <strong>Duties to Other REALTORSÂ®:</strong>
            <ul>
        ...
        <h3>11.5 Local REALTORÂ® Boards</h3>
        <p>
        ...
        <ul>
          <li>Greater Boston Association of REALTORSÂ® (GBAR)</li>
          <li>Cape Cod &amp; Islands Association of REALTORSÂ®</li>
          <li>Berkshire County Board of REALTORSÂ®</li>
          <li>MetroWest Association of REALTORSÂ®</li>
    ...
    body: (
      <>
        ...
        <div className="chapter93a">
          ...
          <h4>ðŸ“‹ Purpose: Level the Playing Field</h4>
          <p>
          ...
          <h4>âš–ï¸ What Chapter 93A Outlaws:</h4>
          ...
          <h4>ðŸ  Real Estate Examples of 93A Violations:</h4>
          <table>
            <thead>
              <tr>
          ...
          <h4>ðŸ’° Penalties & Damages (Severe!):</h4>
          <div className="chapter93a-penalties">
            ...
            <p className="warning">
              <strong>âš ï¸ Why This Is Terrifying:</strong> The attorney's fees provision means even a small violation 
          ...
          <h4>ðŸ“¬ The 30-Day Demand Letter (Critical!):</h4>
          <div className="demand-letter-process">
            ...
            <ul>
              <li>âœ… <strong>DO NOT IGNORE IT!</strong> Ignoring makes damages worse</li>
              <li>âœ… <strong>Contact your E&O insurance immediately</strong> - they may cover defense</li>
              <li>âœ… <strong>Consult an attorney immediately</strong> - real estate attorney experienced in 93A</li>
              <li>âœ… <strong>Respond within 30 days</strong> with reasonable settlement offer</li>
              <li>âœ… <strong>Document everything</strong> - all communications, evidence, timeline</li>
              <li>âœ… <strong>Be professional</strong> - don't get defensive or angry in response</li>
              <li>âŒ <strong>Don't admit fault</strong> without attorney guidance</li>
              <li>âŒ <strong>Don't offer inadequate settlement</strong> - could be seen as bad faith</li>
            </ul>
          ...
          <h4>ðŸ›¡ï¸ How to Protect Yourself from 93A Claims:</h4>
          ...
          <div className="chapter93a-summary">
            <h4>ðŸŽ¯ Bottom Line on Chapter 93A:</h4>
            <ul>
              <li>âœ… It's a <strong>consumer protection law</strong> that applies to ALL businesses</li>
              <li>âœ… Prohibits <strong>unfair or deceptive practices</strong> in ANY commerce</li>
              <li>âœ… Real estate agents are absolutely subject to it</li>
              <li>âœ… Penalties are <strong>severe</strong>: 2x-3x damages + attorney fees</li>
              <li>âœ… <strong>30-day demand letter</strong> is required before lawsuit</li>
              <li>âœ… <strong>Respond immediately</strong> to demand letters - never ignore!</li>
              <li>âœ… Best protection: <strong>honesty, transparency, and full disclosure</strong></li>
            </ul>

            <p className="warning">
              <strong>âš ï¸ Remember:</strong> These are "common sense laws" - don't lie, don't mislead, don't hide 
          ...
          <h4>ðŸ“‹ MCPA's Recommendations - Disclosure & Confidentiality</h4>
          <div className="mcpa-recommendations">
            ...
            <div className="agent-duties">
              <div className="seller-agent-duty">
                <p><strong>ðŸ“Œ Seller's Agent:</strong></p>
                <ul>
              ...
              <div className="buyer-agent-duty">
                <p><strong>ðŸ” Buyer's Agent:</strong></p>
                <ul>
            ...
            <h5>ðŸš¨ When MCPA Overrides Confidentiality (Critical!):</h5>
            ...
            <h5>ðŸ” What You CANNOT Reveal Without Permission:</h5>
            <div className="cannot-reveal">
              ...
              <ul>
                <li><strong>"Motivated Seller!"</strong> 
                  <ul>
                    <li>âŒ Cannot say without permission - reveals seller's urgency</li>
                    <li>âŒ Weakens seller's negotiating position</li>
                    <li>âŒ Personal information about seller (not property)</li>
                    <li>âœ… CAN say if seller gives written permission in listing agreement</li>
                  </ul>
                </li>
                <li><strong>"Make an Offer!"</strong>
                  <ul>
                    <li>âŒ Cannot say without permission - implies seller will accept less</li>
                    <li>âŒ Suggests seller is willing to negotiate below asking</li>
                    <li>âŒ Personal information about seller's willingness to accept lower price</li>
                    <li>âœ… CAN say if seller authorizes this language</li>
                  </ul>
                </li>
              </ul>
              ...
              <ul>
                <li>âŒ Seller is in financial distress</li>
                <li>âŒ Seller has received other offers (unless authorized)</li>
                <li>âŒ Seller's reason for selling (divorce, job loss, relocation urgency)</li>
                <li>âŒ Seller will accept less than listing price</li>
                <li>âŒ Seller's timeline/urgency to close</li>
                <li>âŒ Seller's personal circumstances that create pressure</li>
              </ul>
            </div>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>âŒ NOT WITHOUT PERMISSION</td>
            ...
            <ol>
              ...
              <li><strong>When in Doubt:</strong>
                <ul>
                  <li>Is it about the PROPERTY? â†’ Disclose</li>
                  <li>Is it about the SELLER? â†’ Keep confidential</li>
            ...
            <div className="mcpa-summary">
              <h5>ðŸŽ¯ MCPA Disclosure Summary:</h5>
              <p className="highlight">
              ...
              <p className="warning">
                <strong>âš ï¸ The Line:</strong> Property condition = disclose. Seller's personal situation = 
        ...
        <div className="escrow-accounts">
          ...
          <p className="warning">
            <strong>âš ï¸ VIP NOTE:</strong> Contract may not be binding until the earnest money is received by the 
    ...
    body: (
      <>
        ...
        <div className="personal-info-definition">
          ...
          <ul>
            <li>âœ… <strong>Social Security Number (SSN)</strong></li>
            <li>âœ… <strong>Driver's License Number</strong> and state-issued identification card number</li>
            <li>âœ… <strong>Financial Account Number</strong> or credit/debit card number, WITH OR WITHOUT 
          ...
          <p className="warning">
            âŒ <strong>Public Information is EXCLUDED</strong> - Information lawfully available to the general 
        ...
        <div className="safeguarding-requirements">
          ...
          <ul>
            <li>ðŸ“„ <strong>Paper Records</strong> - Client files, applications, contracts</li>
            <li>ðŸ’» <strong>Electronic Records</strong> - Digital files, databases, emails</li>
            <li>ðŸ–¥ï¸ <strong>Computer Systems</strong> - Desktop computers, servers</li>
            <li>ðŸ’¼ <strong>Laptops</strong> - Mobile computers, notebooks</li>
            <li>ðŸ’¾ <strong>Portable Drive Devices</strong> - USB drives, external hard drives, smartphones, tablets</li>
          </ul>
        ...
        <div className="breach-notification">
          <p className="warning">
            <strong>âš ï¸ CRITICAL:</strong> Any person or business that knows of a breach in security laws 
    ...
    body: (
      <>
        ...
        <div className="dnc-rules">
          ...
          <p className="warning">
            âŒ <strong>MYTH:</strong> Offering "free home valuations" or "free CMAs" exempts you from DNC rules.<br/>
            âœ… <strong>REALITY:</strong> It's STILL telemarketing if purpose is to promote your business. 
            Requires EBR or consent. NO EXEMPTION for "free" offers!
          </p>

          <h4>FSBO Contact Rules:</h4>
          <ul>
            <li>âœ… <strong>CAN call</strong> on behalf of buyer client (representing buyer)</li>
            <li>âŒ <strong>CANNOT call</strong> to solicit listing (marketing yourself)</li>
          </ul>
        </div>
        ...
        <div className="broker-advertising-rules">
          <h4>ðŸš¨ SALESPERSONS ARE PROHIBITED FROM ADVERTISING</h4>
          <p className="highlight">
          ...
          <ul>
            <li><strong>âŒ Cannot Advertise in ANY Way That is False or Misleading</strong>
              <ul>
          ...
          <h4>ðŸš« NO PUFFING!!</h4>
          <div className="no-puffing-warning">
            <p className="warning">
              <strong>PUFFING</strong> = Making something sound better than it really is
            </p>
            <ul>
              <li>âŒ "Better than New"</li>
              <li>âŒ "Best house in town"</li>
              <li>âŒ "Perfect condition" (unless objectively true)</li>
              <li>âŒ "Dream home"</li>
              <li>âŒ "Won't last!" (creates false urgency)</li>
            </ul>
            <p className="highlight">
          ...
          <div className="blind-ads-warning">
            ...
            <ul>
              <li>âŒ "Jane Smith, RealtorÂ® - 781-555-5555" (missing brokerage name)</li>
              <li>âŒ "Call me for a free home valuation!" (no company identification)</li>
              <li>âœ… "Jane Smith - XYZ Realty Corp. - 781-555-5555"</li>
            </ul>
          </div>

          <h4>ðŸ“± SOCIAL MEDIA - Twitter, Facebook, LinkedIn, Instagram, etc.</h4>
          <p className="highlight">
          ...
          <h4>ðŸ“‹ BROKER IDENTIFICATION - Company Name & Phone # Must Be Prominent</h4>
          <div className="broker-id-rules">
            ...
            <div className="advertising-examples">
              ...
              <p className="warning">
                <strong>âŒ WRONG:</strong> Brokerage name "XYZ Corp." is tiny and barely visible. Agent name is prominent. 
                Consumer cannot easily identify the company.
              </p>

              <h5>âœ… CORRECT Example:</h5>
              ...
              <p className="success">
                <strong>âœ… CORRECT:</strong> Brokerage name "XYZ Corp." is prominent and easily visible. Consumer 
          ...
          <div className="advertising-checklist">
            <h4>âœ… Advertising Compliance Checklist:</h4>
            <ol>
              <li>â˜ Broker approved all advertising copy</li>
              <li>â˜ Brokerage name is prominent and easily readable</li>
              <li>â˜ Office phone number is included</li>
              <li>â˜ No puffing or exaggerated claims</li>
              <li>â˜ All statements are factual and verifiable</li>
              <li>â˜ No blind ads (company clearly identified)</li>
              <li>â˜ Social media posts include brokerage in post itself (not just profile)</li>
              <li>â˜ Fair Housing compliance (no discriminatory language or images)</li>
              <li>â˜ Property photos are accurate and current</li>
              <li>â˜ Price and property details are correct</li>
            </ol>
          </div>
        </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p><strong>Example:</strong> Receiving agent earns $10,000 â†’ Referring agent gets $2,000-3,500</p>

        <h4>Out-of-State Referrals:</h4>
        <ul>
          <li>âœ… Generally ALLOWED if you're licensed in at least one state</li>
          <li>âœ… Can receive fees from states where you're not licensed</li>
          <li>âœ… Must be referring from your home state</li>
          <li>âœ… Receiving agent must be licensed in transaction state</li>
        </ul>
        ...
        <div className="warning">
          <p><strong>âŒ UNLICENSED PERSONS CANNOT RECEIVE REFERRAL FEES</strong></p>
          <ul>
        ...
        <ul>
          <li>âŒ Kickbacks for referrals</li>
          <li>âŒ Unearned fees</li>
          <li>âŒ Gifts in exchange for business referrals</li>
          <li>âŒ Payments to settlement service providers for referrals</li>
        </ul>
    ...
    body: (
      <>
        ...
        <div className="eo-insurance">
          ...
          <ul>
            <li>âŒ Intentional acts or fraud</li>
            <li>âŒ Criminal violations</li>
            <li>âŒ Embezzlement</li>
            <li>âŒ Discrimination</li>
          </ul>
    ...
    body: (
      <>
        ...
        <div className="application-requirements">
          ...
          <h4>ðŸ“‹ Citizenship Requirement (Constitutionally Defective - NOT Enforced)</h4>
          <div className="citizenship-requirement">
            <p className="warning">
              <strong>Applicant to show evidence of citizenship or intent of citizenship</strong>
            </p>
            <p className="highlight">
              <strong>âš ï¸ IMPORTANT:</strong> The "board" based on Attorney General's opinion, <strong>declared this 
            ...
            <p className="success">
              <strong>âœ… Bottom Line:</strong> Don't worry about this requirement - the Board does not enforce it 
              and will not ask for proof of citizenship. This is an outdated law that remains on the books but is 
              not applied.
            </p>
          </div>

          <h4>ðŸ’° Tax Compliance (STRICTLY ENFORCED)</h4>
          <div className="tax-requirement">
            ...
            <p className="highlight">
              <strong>âš ï¸ This IS Enforced:</strong> Unlike the citizenship requirement, tax compliance is strictly 
              enforced. If you owe MA taxes or haven't filed returns, your license application will be denied or 
              delayed until resolved.
            </p>
          </div>

          <h4>ðŸ›¡ï¸ Broker Surety Bond Requirement</h4>
          ...
          <h4>ðŸŽ¤ Board Interview (If Deemed Necessary)</h4>
          ...
          <h4>âœ… Complete License Application Checklist:</h4>
          <div className="application-checklist">
            <h5>For Salesperson License:</h5>
            <ol>
              <li>â˜ Complete 40-hour pre-license course from approved school</li>
              <li>â˜ Pass state salesperson exam (score 70% or higher)</li>
              <li>â˜ Complete license application (online or paper)</li>
              <li>â˜ Pay application fee ($100-150)</li>
              <li>â˜ Submit background check/fingerprints</li>
              <li>â˜ Verify all MA state taxes filed and paid</li>
              <li>â˜ <s>Provide proof of citizenship</s> (NOT ENFORCED - ignore this)</li>
              <li>â˜ Wait for Board approval</li>
              <li>â˜ Affiliate with licensed broker before license issued</li>
              <li>â˜ Appear for interview if requested by Board</li>
            </ol>

            <h5>For Broker License (Additional Requirements):</h5>
            <ol>
              <li>â˜ 3+ years as licensed salesperson (MA or equivalent)</li>
              <li>â˜ Complete 30-hour broker pre-license course</li>
              <li>â˜ Pass state broker exam (score 70% or higher)</li>
              <li>â˜ Complete broker license application</li>
              <li>â˜ Pay broker application fee ($150-200)</li>
              <li>â˜ Submit background check/fingerprints</li>
              <li>â˜ Verify all MA state taxes filed and paid</li>
              <li>â˜ <strong>Obtain $5,000 surety bond</strong> (CRITICAL - broker only!)</li>
              <li>â˜ Submit proof of surety bond to Board</li>
              <li>â˜ <s>Provide proof of citizenship</s> (NOT ENFORCED - ignore this)</li>
              <li>â˜ Wait for Board approval</li>
              <li>â˜ Appear for interview if requested by Board</li>
            </ol>
          ...
          <h4>â±ï¸ Timeline for License Application:</h4>
          <ul>
          ...
          <div className="application-summary">
            <h4>ðŸŽ¯ Application Requirements Summary:</h4>
            <ul>
              <li>âœ… <strong>Tax Compliance:</strong> STRICTLY ENFORCED - must have all MA taxes filed and paid</li>
              <li>âœ… <strong>Broker Surety Bond:</strong> REQUIRED for brokers - $5,000 minimum</li>
              <li>âœ… <strong>Board Interview:</strong> POSSIBLE - be prepared, honest, and professional</li>
              <li>âŒ <strong>Citizenship:</strong> NOT ENFORCED - don't worry about this outdated requirement</li>
            </ul>
            <p className="warning">
              <strong>âš ï¸ Most Common Application Delays:</strong> Outstanding MA tax debt and incomplete background 
        ...
        <div className="license-structure">
          <h4>ðŸ¢ Broker License Entity Types</h4>
          ...
          <h4>ðŸ“ D/B/A's (Doing Business As) - Agency Disclosure Requirements</h4>
          ...
          <h4>ðŸ‘¥ Teams Cannot Get Licensed</h4>
          <div className="team-licensing">
            ...
            <ul>
              ...
              <li><strong>Examples:</strong>
                <ul>
                  <li>âŒ "The Smith Team" cannot hold a broker license</li>
                  <li>âŒ "Premier Sales Group" cannot get licensed as a team</li>
                  <li>âœ… Team members must be individually licensed under a broker</li>
                </ul>
              </li>
          ...
          <h4>ðŸ‘” Designated Officer Requirement (For Entity Brokers)</h4>
          ...
          <h4>ðŸ“… Examination Frequency Requirements</h4>
          ...
          <h4>â™¿ Fee Waivers for Disabled Veterans and Blind Persons</h4>
          ...
          <div className="license-structure-summary">
            <h4>ðŸŽ¯ License Structure Summary:</h4>
            <ul>
              <li>âœ… <strong>Broker licenses:</strong> Can be held by corporations, societies, associations, partnerships, or individuals</li>
              <li>âœ… <strong>D/B/A's:</strong> Must show broker owner name & license # on agency disclosure forms</li>
              <li>âœ… <strong>Teams:</strong> Cannot get licensed (marketing groups only, individuals must be licensed)</li>
              <li>âœ… <strong>Designated Officer:</strong> Entities must have ONE designated officer with broker license</li>
              <li>âœ… <strong>Exams:</strong> Broker minimum 6x/year, Salesperson minimum 8x/year</li>
              <li>âœ… <strong>Fee Waivers:</strong> Available for blind persons and paraplegic veterans</li>
            </ul>
          </div>
        </div>
        ...
        <div className="certifications">
          <h4>GRI (Graduate, REALTORÂ® Institute)</h4>
          <ul>
        ...
        <div className="requirements-table">
          <h4>âœ… MANDATORY (Required to Practice):</h4>
          <ul>
          ...
          <h4>ðŸ’¡ OPTIONAL (Recommended for Success):</h4>
          <ul>
        ...
        <div className="licensing-requirements">
          <h4>ðŸš¨ Criminal Conviction Reporting (30-Day Rule)</h4>
          <div className="conviction-reporting">
            ...
            <ul>
              <li>âŒ Automatic license suspension or revocation</li>
              <li>âŒ Additional disciplinary action for failure to report</li>
              <li>âŒ Cannot claim ignorance of requirement</li>
              <li>âŒ More severe penalties than if you had reported timely</li>
            </ul>
          ...
          <h4>ðŸ“š Fraudulent Education Certification (License Suspension)</h4>
          ...
          <h4>ðŸ”’ License Surrender (7-Day Rule)</h4>
          <div className="license-surrender">
            ...
            <ul>
              <li>âŒ Additional disciplinary action</li>
              <li>âŒ Extended suspension period</li>
              <li>âŒ Possible contempt charges</li>
              <li>âŒ Harder to get reinstated</li>
              <li>âŒ Shows lack of cooperation with Board</li>
            </ul>

            <h5>During Suspension/Revocation:</h5>
            <ul>
              <li>âŒ <strong>CANNOT</strong> practice real estate</li>
              <li>âŒ <strong>CANNOT</strong> earn commissions</li>
              <li>âŒ <strong>CANNOT</strong> represent yourself as licensed agent</li>
              <li>âŒ <strong>CANNOT</strong> work on deals that started before suspension</li>
              <li>âœ… <strong>CAN</strong> work on getting reinstated (if suspension)</li>
              <li>âœ… <strong>MUST</strong> notify broker immediately</li>
              <li>âœ… <strong>MUST</strong> notify clients on active deals</li>
            </ul>
          ...
          <div className="licensing-summary">
            <h4>ðŸŽ¯ Key Takeaways - Licensing Compliance:</h4>
            <ul>
              <li>âœ… <strong>Report ANY conviction within 30 days</strong> - no exceptions!</li>
              <li>âœ… <strong>Never fake CE completion</strong> - career suicide</li>
              <li>âœ… <strong>Surrender license within 7 days if suspended/revoked</strong></li>
              <li>âœ… <strong>Keep license active and in good standing</strong></li>
              <li>âœ… <strong>Cooperate with the Board</strong> - honesty helps your case</li>
              <li>âœ… <strong>Don't practice during suspension</strong> - serious consequences</li>
              <li>âœ… <strong>Track CE hours religiously</strong> - don't let them lapse</li>
              <li>âœ… <strong>Report violations to broker immediately</strong></li>
            </ul>

            <p className="warning">
              <strong>âš ï¸ The Board Takes These Seriously:</strong> License violations are not minor issues. 
          ...
          <h4>âš ï¸ Complete List: Suspension or Refusal to Renew License</h4>
          <div className="suspension-reasons">
            ...
            <div className="violation-list">
              ...
              <div className="violation-item">
                ...
                <ul>
                  ...
                  <li><strong>Example:</strong> Inspector pays you $100 for referral â†’ MUST disclose to client</li>
              ...
              <div className="violation-item">
                ...
                <h6>ðŸ“‹ What is a Net Listing?</h6>
                ...
                <h6>ðŸ’° How Net Listings Work (Example Scenarios):</h6>
                ...
                <h6>ðŸš« Why Net Listings are ILLEGAL in Massachusetts:</h6>
                ...
                <h6>âš–ï¸ Legal Status in Massachusetts:</h6>
                <ul>
                ...
                <h6>âš ï¸ Consequences of Using Net Listing:</h6>
                ...
                <h6>âœ… LEGAL Alternatives to Net Listings:</h6>
                ...
                <h6>âŒ Common Misconceptions About Net Listings:</h6>
                <div className="net-listing-myths">
                  <p><strong>Myth 1: "If the seller agrees, it's okay"</strong></p>
                  <ul>
                    <li>âŒ <strong>FALSE:</strong> Net listings are illegal even with seller consent</li>
                  ...
                  <ul>
                    <li>âŒ <strong>FALSE:</strong> Seller knows minimum but doesn't know if agent is hiding true value</li>
                  ...
                  <ul>
                    <li>âŒ <strong>FALSE:</strong> Agent profits MORE from hiding true value and listing low</li>
            ...
            <div className="suspension-summary">
              <h4>ðŸŽ¯ Suspension/Refusal to Renew Summary:</h4>
              <p className="warning">
          ...
          <h4>âš–ï¸ Enforcement of Board Investigations - Due Process Procedures</h4>
          <div className="board-investigations">
            ...
            <div className="investigation-procedures">
              <div className="procedure-step">
                <h5>ðŸ“ Step 1: Complaint Must Be in Writing</h5>
                <p className="warning">
              ...
              <div className="procedure-step">
                <h5>ðŸ“… Step 2: Hearing Upon 10 Days Notice</h5>
                <p className="warning">
                ...
                <p className="highlight">
                  <strong>âš ï¸ STRONGLY RECOMMENDED:</strong> Hire an attorney who specializes in real estate 
                  licensing defense. Board hearings are serious legal proceedings. Do not go alone.
                </p>
              </div>

              <div className="procedure-step">
                <h5>ðŸ›¡ï¸ Step 3: No Action Until After Hearing & Finding</h5>
                <p className="warning">
              ...
              <div className="procedure-step">
                <h5>ðŸ“š Step 4: Board's Investigative Powers</h5>
                <p className="warning">
              ...
              <div className="procedure-step">
                <h5>âš–ï¸ Step 5: Compelling Witness Testimony</h5>
                <p className="warning">
              ...
              <div className="procedure-step">
                <h5>âœï¸ Step 6: Board Decision Requirements</h5>
                <p className="warning">
              ...
              <div className="procedure-step">
                <h5>ðŸ“ž Step 7: Right to Appeal</h5>
                <p className="warning">
                ...
                <p className="warning">
                  <strong>âš ï¸ CRITICAL:</strong> Do NOT miss the 20-day appeal deadline! Mark it on your 
            ...
            <div className="investigation-timeline">
              <h5>â±ï¸ Typical Investigation Timeline:</h5>
              <ul>
            ...
            <div className="investigation-best-practices">
              <h5>ðŸŽ¯ What to Do If You Receive a Board Complaint:</h5>
              <ol>
            ...
            <div className="investigation-summary">
              <h4>ðŸŽ¯ Board Investigation Process Summary:</h4>
              <p className="warning">
              ...
              <ul>
                <li>âœ… <strong>Complaint:</strong> Must be written and signed</li>
                <li>âœ… <strong>Notice:</strong> At least 10 days before hearing</li>
                <li>âœ… <strong>Due Process:</strong> No penalty until after hearing and finding</li>
                <li>âœ… <strong>Board Powers:</strong> Can summon witnesses and documents</li>
                <li>âœ… <strong>Court Enforcement:</strong> Superior Court can compel witness appearance</li>
                <li>âœ… <strong>Decision:</strong> Majority vote, written, signed by all members</li>
                <li>âœ… <strong>Appeal:</strong> 20 days to appeal to Superior Court</li>
              </ul>
              <p className="highlight">
        ...
        <div className="license-exemptions">
          ...
          <h4>âœ… Persons Exempt from Licensing:</h4>
          <div className="exemption-list">
            ...
            <div className="exemption-item">
              ...
              <ul>
                ...
                <li><strong>âš ï¸ EXCEPTION:</strong> If collecting commission on leasing/sales = license required</li>
                <li><strong>Key Distinction:</strong> Managing properties â‰  selling/leasing for commission</li>
              </ul>
            </div>
          ...
          <h4>âŒ Who DOES Need a License:</h4>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>âš ï¸ GRAY AREA</td>
                <td>If assigning contracts = might need license. Consult attorney.</td>
              </tr>
            </tbody>
          </table>

          <h4>âš ï¸ Penalties for Practicing Without a License:</h4>
          <div className="unlicensed-penalties">
            ...
            <p className="warning">
              <strong>âš ï¸ Important:</strong> If you engage in real estate activity requiring a license without 
        ...
        <p className="highlight">
          <strong>Career Path:</strong> Salesperson (3+ years) â†’ Broker â†’ Brokerage Owner â†’ Multi-State Broker.
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p><strong>What It's NOT:</strong> âŒ Not automatic licensing âŒ Not permission to practice cross-border 
        âŒ Not the same as having two licenses</p>

        <h3>14.2 Massachusetts Neighboring States</h3>
        <div className="state-comparison">
          <h4>Rhode Island (EASIEST) â­</h4>
          <ul>
            <li><strong>Reciprocity:</strong> âœ… YES</li>
          ...
          <h4>New Hampshire (POPULAR) â­â­</h4>
          <ul>
            <li><strong>Reciprocity:</strong> âœ… YES</li>
          ...
          <h4>New York (HARDEST) â­â­â­â­â­</h4>
          <ul>
            <li><strong>Reciprocity:</strong> âŒ NO</li>
...
Negotiate commissions for volume â€“ think long game.
Offer flexible closings and rent-backs to beat higher-priced offers.
Always understand your agentâ€™s split and cap â€“ it influences incentives.`}
        </pre>
      </>
    )
  },
  {
    ...
    body: (
      <>
        ...
        <ul>
          <li>âœ… Complete approved 40-hour Massachusetts real estate pre-licensing course</li>
          <li>âœ… Be at least 18 years old</li>
          <li>âœ… Have a high school diploma or equivalent</li>
          <li>âœ… Submit fingerprints for background check</li>
          <li>âœ… Receive exam authorization from Massachusetts Board of Registration of Real Estate Brokers & Salespersons</li>
        </ul>
        ...
        <p><strong>â° Scheduling Tip:</strong> Schedule at least 2-3 weeks in advance for best availability. Morning slots (8am-10am) tend to fill fastest.</p>

        <h3>6.4 Exam Day: What to Bring</h3>
        <h4>âœ… Required Items:</h4>
        <ul>
        ...
        <ul>
          ...
          <li>âŒ <strong>No appeals:</strong> Scores are final and cannot be challenged</li>
        </ul>
        ...
        <ul>
          <li>âœ… <strong>2025 Law Changes:</strong> Inspection waiver disclosure, commission negotiation rules</li>
          <li>âœ… <strong>License Law:</strong> Salesperson vs broker requirements, supervision, continuing education</li>
          <li>âœ… <strong>Agency Relationships:</strong> Buyer agency, seller agency, dual agency, designated agency</li>
          <li>âœ… <strong>Required Disclosures:</strong> Lead paint, property condition, agency disclosure</li>
          <li>âœ… <strong>Fair Housing:</strong> Protected classes, steering, blockbusting, redlining</li>
          <li>âœ… <strong>Contracts:</strong> Offer to Purchase, Purchase & Sale Agreement, contingencies</li>
          <li>âœ… <strong>Escrow Accounts:</strong> Trust account management, deposits, record keeping</li>
        </ul>

        <h4>National Topics - Most Tested</h4>
        <ul>
          <li>âœ… <strong>Agency Law:</strong> Fiduciary duties (OLD-CAR: Obedience, Loyalty, Disclosure, Confidentiality, Accounting, Reasonable Care)</li>
          <li>âœ… <strong>Fair Housing Act:</strong> Protected classes, exemptions, penalties</li>
          <li>âœ… <strong>Contract Law:</strong> Offer, acceptance, consideration, legal purpose, capacity</li>
          <li>âœ… <strong>Property Rights:</strong> Fee simple, life estate, easements, encumbrances</li>
          <li>âœ… <strong>Financing:</strong> Conventional, FHA, VA loans; PITI, LTV, qualifying ratios</li>
          <li>âœ… <strong>Valuation:</strong> Three approaches (sales comparison, cost, income), CMA</li>
          <li>âœ… <strong>Deeds & Title:</strong> Types of deeds, title insurance, recording</li>
        </ul>
        ...
        <div className="highlight">
          ...
          <pre>
{`Sale Price Ã— Commission Rate = Total Commission
$300,000 Ã— 5% = $15,000

Commission Split:
Total Commission Ã— Agent's % = Agent's Share
$15,000 Ã— 60% = $9,000 to agent`}
          </pre>

          <h4>Proration (Property Taxes):</h4>
          <pre>
{`Annual Tax Ã· 365 = Daily Rate
Daily Rate Ã— Number of Days = Prorated Amount

Example: $3,650 annual tax, close on day 100
$3,650 Ã· 365 = $10/day
$10 Ã— 100 days = $1,000 (seller owes)`}
          </pre>

          <h4>Area Calculations:</h4>
          <pre>
{`Rectangle: Length Ã— Width
Square Feet to Acres: SF Ã· 43,560
Acres to Square Feet: Acres Ã— 43,560

Example: 10,000 SF lot
10,000 Ã· 43,560 = 0.23 acres`}
          </pre>

          <h4>Loan Qualifying:</h4>
          <pre>
{`Housing Ratio = (PITI Ã· Monthly Income) Ã— 100
Debt Ratio = (Total Debt Ã· Monthly Income) Ã— 100
...
FHA Max: 31% housing, 43% total debt`}
        ...
        <ul>
          <li>ðŸŽ¯ <strong>Read carefully:</strong> Questions often include "EXCEPT" or "NOT" - circle these words</li>
          <li>ðŸŽ¯ <strong>Eliminate wrong answers:</strong> Cross out obviously incorrect options first</li>
          <li>ðŸŽ¯ <strong>Flag and return:</strong> If unsure, flag the question and come back later</li>
          <li>ðŸŽ¯ <strong>Time management:</strong> 110 questions in 210 minutes = ~2 minutes per question</li>
          <li>ðŸŽ¯ <strong>Calculator:</strong> On-screen calculator provided - practice with it in tutorial</li>
          <li>ðŸŽ¯ <strong>No penalty:</strong> No penalty for guessing - answer every question</li>
          <li>ðŸŽ¯ <strong>Review flagged:</strong> Use remaining time to review flagged questions</li>
          <li>ðŸŽ¯ <strong>Don't overthink:</strong> First instinct is usually correct</li>
        </ul>

        <h3>6.13 Study Resources</h3>
        <ul>
          <li>ðŸ“š <strong>Official PSI Practice Exam:</strong> Available at www.psiexams.com ($25)</li>
          <li>ðŸ“š <strong>MA Board Website:</strong> www.mass.gov/orgs/board-of-registration-of-real-estate-brokers-and-salespersons</li>
          <li>ðŸ“š <strong>This Guide:</strong> Use Study Mode, Quiz Mode, and Practice Exam features</li>
          <li>ðŸ“š <strong>School Materials:</strong> Review all course materials from your 40-hour program</li>
          <li>ðŸ“š <strong>Flashcards:</strong> Create flashcards for formulas and key terms</li>
          <li>ðŸ“š <strong>Study Groups:</strong> Join or form study groups with classmates</li>
        </ul>
        ...
        <div className="law-change-banner" style={{marginTop: '1rem'}}>
          <div className="law-banner-content">
            <span className="law-banner-icon">âš ï¸</span>
            <div className="law-banner-text">
              <ul style={{margin: 0, paddingLeft: '1.5rem'}}>
                <li>âŒ Not managing time - rushing through last 20 questions</li>
                <li>âŒ Changing too many answers on review (stick with first instinct)</li>
                <li>âŒ Missing "EXCEPT" or "NOT" keywords in questions</li>
                <li>âŒ Confusing state vs national law requirements</li>
                <li>âŒ Forgetting to bring required IDs</li>
                <li>âŒ Cramming the night before (study 1-2 weeks before exam)</li>
                <li>âŒ Not taking practice exams under timed conditions</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <pre>
{`ðŸ“ EXAM FORMAT
â€¢ 110 questions total (80 national + 30 state)
â€¢ 70% to pass BOTH portions
â€¢ 3.5 hours (210 minutes)
â€¢ $85 fee
â€¢ Computer-based at PSI test centers

ðŸ“… SCHEDULING
â€¢ www.psiexams.com or 1-800-733-9267
â€¢ Schedule 2-3 weeks in advance
â€¢ Bring 2 IDs (1 government photo ID)

âœ… CONTENT FOCUS
â€¢ Agency Law (19% of national)
â€¢ MA License Law (33% of state)
â€¢ Fair Housing, Contracts, Financing
â€¢ Know calculations: commission, proration, area, LTV

ðŸŽ¯ TEST STRATEGY
â€¢ Read carefully - watch for "EXCEPT" and "NOT"
â€¢ 2 minutes per question average
â€¢ Flag uncertain questions, review later
â€¢ No penalty for guessing - answer all 110
â€¢ Trust first instinct when reviewing

ðŸ”„ RETAKES
â€¢ No waiting period
â€¢ $85 per retake
â€¢ Only retake failed portion
â€¢ Score report shows weak areas`}
        </pre>
      </>
    )
  },
...
â€¢ Offer must be written; counter-offer cancels previous offer.
â€¢ Acceptance + delivery = binding contract (subject to contingencies).
â€¢ Buyer must receive home-inspection disclosure before first written offer.
â€¢ Sellers cannot require inspection waivers.
â€¢ Buyer-broker compensation is fully negotiable and appears in the offer.
â€¢ Buyer must sign a buyer-broker agreement before touring homes.
â€¢ All commissions are negotiable; no standard rate.
â€¢ Dual agency requires written informed consent; agent must stay neutral.
â€¢ Deposits (offer + P&S) held in escrow; refunded if contingencies not met.
â€¢ P&S clarifies inspection, financing, appraisal, title, and closing details.
â€¢ Brokers are responsible for acts of sales associates.
â€¢ Agents are independent contractors, paid by commission, receiving 1099s.
â€¢ Commission splits (50/50, 60/40, 70/30, 80/20, 90/10) and cap plans vary by brokerage.
â€¢ MLS and Board membership often required; company rules and minimum production may apply.
â€¢ Backup offers allowed with proper disclosure.
â€¢ Investors can exploit terms (credits, timing, contingencies, commissions) to create winâ€“win deals.`}
        </pre>
      </>
    )
  }
